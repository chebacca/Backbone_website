 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oe(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Yt(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(oe())}function Ae(){var e;const t=(e=A())==null?void 0:e.forceEnvironment;if(t==="node")return!0;if(t==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function qt(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function Xt(){const t=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof t=="object"&&t.id!==void 0}function Qt(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function en(){const t=oe();return t.indexOf("MSIE ")>=0||t.indexOf("Trident/")>=0}function tn(){return!Ae()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function Be(){try{return typeof indexedDB=="object"}catch{return!1}}function Oe(){return new Promise((t,e)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(r);s.onsuccess=()=>{s.result.close(),n||self.indexedDB.deleteDatabase(r),t(!0)},s.onupgradeneeded=()=>{n=!1},s.onerror=()=>{var i;e(((i=s.error)==null?void 0:i.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cn(t){return t&&t._delegate?t._delegate:t}class D{constructor(e,n,r){this.name=e,this.instanceFactory=n,this.type=r,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tt{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(nt(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function nt(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const L="@firebase/app",X="0.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const u=new je("@firebase/app"),rt="@firebase/app-compat",st="@firebase/analytics-compat",it="@firebase/analytics",ot="@firebase/app-check-compat",at="@firebase/app-check",ct="@firebase/auth",ht="@firebase/auth-compat",lt="@firebase/database",dt="@firebase/data-connect",ft="@firebase/database-compat",ut="@firebase/functions",pt="@firebase/functions-compat",mt="@firebase/installations",gt="@firebase/installations-compat",bt="@firebase/messaging",yt="@firebase/messaging-compat",Et="@firebase/performance",_t="@firebase/performance-compat",Ct="@firebase/remote-config",wt="@firebase/remote-config-compat",vt="@firebase/storage",It="@firebase/storage-compat",Dt="@firebase/firestore",St="@firebase/ai",At="@firebase/firestore-compat",Bt="firebase",Ot="12.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dn=Ot;function Rt(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r={name:k,automaticDataCollectionEnabled:!0,...e},s=r.name;if(typeof s!="string"||!s)throw g.create("bad-app-name",{appName:String(s)});if(n||(n=ie()),!n)throw g.create("no-options");const i=S.get(s);if(i){if($(n,i.options)&&$(r,i.config))return i;throw g.create("duplicate-app",{appName:s})}const o=new Le(s);for(const c of F.values())o.addComponent(c);const l=new Nt(n,r,o);return S.set(s,l),l}function fn(t=k){const e=S.get(t);if(!e&&t===k&&ie())return Rt();if(!e)throw g.create("no-app",{appName:t});return e}function N(t,e,n){let r=Tt[t]??t;n&&(r+=`-${n}`);const s=r.match(/\s|\//),i=e.match(/\s|\//);if(s||i){const o=[`Unable to register library "${r}" with version "${e}":`];s&&o.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&i&&o.push("and"),i&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),u.warn(o.join(" "));return}U(new D(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $t="firebase-heartbeat-database",Pt=1,_="firebase-heartbeat-store";let R=null;function le(){return R||(R=Xe($t,Pt,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(_)}catch(n){console.warn(n)}}}}).catch(t=>{throw g.create("idb-open",{originalErrorMessage:t.message})})),R}async function Ht(t){try{const n=(await le()).transaction(_),r=await n.objectStore(_).get(de(t));return await n.done,r}catch(e){if(e instanceof C)u.warn(e.message);else{const n=g.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});u.warn(n.message)}}}async function ee(t,e){try{const r=(await le()).transaction(_,"readwrite");await r.objectStore(_).put(e,de(t)),await r.done}catch(n){if(n instanceof C)u.warn(n.message);else{const r=g.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});u.warn(r.message)}}}function de(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zt(t){U(new D("platform-logger",e=>new tt(e),"PRIVATE")),U(new D("heartbeat",e=>new Ft(e),"PRIVATE")),N(L,X,t),N(L,X,"esm2020"),N("fire-js","")}zt("");export{Zt as A,tn as B,D as C,ae as E,C as F,je as L,dn as S,hn as _,Gt as a,we as b,cn as c,ln as d,$ as e,Ie as f,fn as g,oe as h,Rt as i,on as j,en as k,nn as l,rn as m,Yt as n,Qt as o,Jt as p,sn as q,N as r,be as s,h as t,Kt as u,Xt as v,qt as w,U as x,an as y,Wt as z};
