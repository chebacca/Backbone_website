...
import { j as jsxRuntimeExports, B as Box, T as Typography, aQ as Tabs, aR as Tab, c as Paper, G as Grid, S as Stack, e as TextField, bw as ToggleButtonGroup, bx as ToggleButton, aj as FormControl, ak as InputLabel, al as Select, M as MenuItem, am as ButtonGroup, a as Button, R as RefreshIcon, a3 as Download, by as Print, bz as Save, bA as Restore, D as Divider, bB as Autocomplete, bC as Map, bD as Launch, bE as Public, d as Alert, aw as Table, ax as TableHead, ay as TableRow, az as TableCell, aA as TableBody, aI as Tooltip, g as IconButton, at as Receipt, r as Chip, av as TableContainer, h as Visibility } from "./mui-DKIosbOx.js";
import { r as reactExports, e as useLocation, u as useNavigate } from "./vendor-Cu2L4Rr-.js";
import { c as api, e as endpoints } from "./index-CDEjieLs.js";
...
const AccountingDashboard = () => {
  ...
  reactExports.useEffect(() => {
    const load = () => __async(void 0, null, function* () {
      ...
      fetchPayments();
      const [ov, tax, ev, consentsLatest] = yield Promise.all([
      ...
      setEvents(((_d2 = (_c2 = ev.data) == null ? void 0 : _c2.data) == null ? void 0 : _d2.events) || []);
      setTermsRows(((_f = (_e = consentsLatest.data) == null ? void 0 : _e.data) == null ? void 0 : _f.users) || []);
      try {
        const resCompany = yield api.get(endpoints.admin.companyFilingGet());
        const c = (_h = (_g = resCompany.data) == null ? void 0 : _g.data) == null ? void 0 : _h.company;
    ...
    if (filingScheme === "US_SALES_TAX") {
      ...
      for (const [country, v] of Object.entries(byCountry)) {
        rows.push({
          ...
          taxable_cents: (_e = v.taxable_cents) != null ? _e : 0,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { p: 3 }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", color: "text.secondary", gutterBottom: true, children: "Financial reporting, tax, and regulatory oversight snapshot." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableContainer, { component: Paper, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { size: "small", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: payments.map((p) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: (_f = (_e = p.user) == null ? void 0 : _e.taxInformation) == null ? void 0 : _f.taxResidency }),
