const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/firebase-CxbSQ7r3.js","assets/index-C4eF6KWV.js","assets/mui-kQ2X8N0A.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-TEyM19uV.js","assets/index-COak77tQ.css","assets/index.esm-6tSZEpI2.js","assets/index.esm-CORWL332.js","assets/index.esm-Bwx4LHm0.js","assets/UnifiedDataService-CmxnkHtJ.js","assets/FirestoreCollectionManager-C0cVebWr.js"])))=>i.map(i=>d[i]);
...
const _FirestoreAdapter = class _FirestoreAdapter {
  ...
  initialize() {
    return __async(this, null, function* () {
      const firebase = yield __vitePreload(() => import("./firebase-CxbSQ7r3.js").then((n) => n.f), true ? __vite__mapDeps([0,1,2,3,4,5,6,7,8]) : void 0);
      this.db = firebase.db;
    ...
    return __async(this, null, function* () {
      try {
        const { doc, getDoc } = yield __vitePreload(() => __async(this, null, function* () {
          const { doc: doc2, getDoc: getDoc2 } = yield import("./index.esm-CORWL332.js");
    ...
    return __async(this, arguments, function* (collectionName, queryConditions = []) {
      try {
        const { collection, query, where, getDocs } = yield __vitePreload(() => __async(this, null, function* () {
          const { collection: collection2, query: query2, where: where2, getDocs: getDocs2 } = yield import("./index.esm-CORWL332.js");
    ...
    return __async(this, null, function* () {
      try {
        const { collection, addDoc } = yield __vitePreload(() => __async(this, null, function* () {
          const { collection: collection2, addDoc: addDoc2 } = yield import("./index.esm-CORWL332.js");
    ...
    return __async(this, null, function* () {
      try {
        const { doc, updateDoc } = yield __vitePreload(() => __async(this, null, function* () {
          const { doc: doc2, updateDoc: updateDoc2 } = yield import("./index.esm-CORWL332.js");
          return { doc: doc2, updateDoc: updateDoc2 };
        }), true ? __vite__mapDeps([7,6]) : void 0);
        const { arrayUnion, arrayRemove } = yield __vitePreload(() => __async(this, null, function* () {
          const { arrayUnion: arrayUnion2, arrayRemove: arrayRemove2 } = yield import("./index.esm-CORWL332.js");
    ...
    return __async(this, null, function* () {
      try {
        const { doc, deleteDoc } = yield __vitePreload(() => __async(this, null, function* () {
          const { doc: doc2, deleteDoc: deleteDoc2 } = yield import("./index.esm-CORWL332.js");
          ...
          for (const ptm of projectTeamMembersCollection) {
            if (!teamMembers.find((tm) => tm.teamMemberId === ptm.teamMemberId)) {
              teamMembers.push({
                ...
                assignedAt: ptm.assignedAt || (/* @__PURE__ */ new Date()).toISOString(),
    ...
    return __async(this, null, function* () {
      try {
        ...
        const { createUserWithEmailAndPassword } = yield __vitePreload(() => __async(this, null, function* () {
          const { createUserWithEmailAndPassword: createUserWithEmailAndPassword2 } = yield import("./index.esm-Bwx4LHm0.js");
    ...
    return __async(this, null, function* () {
      try {
        ...
        const { db } = yield __vitePreload(() => __async(this, null, function* () {
          const { db: db2 } = yield import("./firebase-CxbSQ7r3.js").then((n) => n.f);
          return { db: db2 };
        }), true ? __vite__mapDeps([0,1,2,3,4,5,6,7,8]) : void 0);
        const { doc, updateDoc, getDoc, collection, query, where, getDocs, deleteDoc } = yield __vitePreload(() => __async(this, null, function* () {
          const { doc: doc2, updateDoc: updateDoc2, getDoc: getDoc2, collection: collection2, query: query2, where: where2, getDocs: getDocs2, deleteDoc: deleteDoc2 } = yield import("./index.esm-CORWL332.js");
    ...
    return __async(this, null, function* () {
      try {
        ...
        const { doc, getDoc, collection, query, where, getDocs, deleteDoc, writeBatch } = yield __vitePreload(() => __async(this, null, function* () {
          const { doc: doc2, getDoc: getDoc2, collection: collection2, query: query2, where: where2, getDocs: getDocs2, deleteDoc: deleteDoc2, writeBatch: writeBatch2 } = yield import("./index.esm-CORWL332.js");
    ...
    return __async(this, null, function* () {
      ...
      try {
        ...
        const { db, auth } = yield __vitePreload(() => __async(this, null, function* () {
          const { db: db2, auth: auth2 } = yield import("./firebase-CxbSQ7r3.js").then((n) => n.f);
          return { db: db2, auth: auth2 };
        }), true ? __vite__mapDeps([0,1,2,3,4,5,6,7,8]) : void 0);
        const { doc, setDoc, collection, getDoc } = yield __vitePreload(() => __async(this, null, function* () {
          const { doc: doc2, setDoc: setDoc2, collection: collection2, getDoc: getDoc2 } = yield import("./index.esm-CORWL332.js");
    ...
    return __async(this, null, function* () {
      ...
      try {
        ...
        const { doc, getDoc, updateDoc, serverTimestamp } = yield __vitePreload(() => __async(this, null, function* () {
          const { doc: doc2, getDoc: getDoc2, updateDoc: updateDoc2, serverTimestamp: serverTimestamp2 } = yield import("./index.esm-CORWL332.js");
        ...
        const { doc: docFn } = yield __vitePreload(() => __async(this, null, function* () {
          const { doc: docFn2 } = yield import("./index.esm-CORWL332.js");
          return { doc: docFn2 };
        }), true ? __vite__mapDeps([7,6]) : void 0);
    ...
    return __async(this, null, function* () {
      try {
        ...
        const { collection, query, where, getDocs, doc, getDoc } = yield __vitePreload(() => __async(this, null, function* () {
          const { collection: collection2, query: query2, where: where2, getDocs: getDocs2, doc: doc2, getDoc: getDoc2 } = yield import("./index.esm-CORWL332.js");
    ...
    return __async(this, null, function* () {
      try {
        ...
        const { collection, query, where, getDocs, orderBy } = yield __vitePreload(() => __async(this, null, function* () {
          const { collection: collection2, query: query2, where: where2, getDocs: getDocs2, orderBy: orderBy2 } = yield import("./index.esm-CORWL332.js");
    ...
    return __async(this, null, function* () {
      ...
      try {
        ...
        const { doc, updateDoc, getDoc, collection, addDoc, query, where, getDocs } = yield __vitePreload(() => __async(this, null, function* () {
          const { doc: doc2, updateDoc: updateDoc2, getDoc: getDoc2, collection: collection2, addDoc: addDoc2, query: query2, where: where2, getDocs: getDocs2 } = yield import("./index.esm-CORWL332.js");
