const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/firebase-CDtyYuri.js","assets/index-B4mxxIt4.js","assets/mui-BbtiZaA3.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-rmDQXWB-.js","assets/index-COak77tQ.css","assets/index.esm-zVCMB3Cx.js","assets/index.esm-CjtNHFZy.js","assets/index.esm-BMygn4u3.js","assets/UnifiedDataService-0af7UUQn.js","assets/FirestoreCollectionManager-BZXUYliG.js"])))=>i.map(i=>d[i]);
...
const _FirestoreAdapter = class _FirestoreAdapter {
  ...
  initialize() {
    return __async(this, null, function* () {
      const firebase = yield __vitePreload(() => import("./firebase-CDtyYuri.js").then((n) => n.f), true ? __vite__mapDeps([0,1,2,3,4,5,6,7,8]) : void 0);
      this.db = firebase.db;
    ...
    return __async(this, null, function* () {
      try {
        ...
        const { db } = yield __vitePreload(() => __async(this, null, function* () {
          const { db: db2 } = yield import("./firebase-CDtyYuri.js").then((n) => n.f);
          return { db: db2 };
        }), true ? __vite__mapDeps([0,1,2,3,4,5,6,7,8]) : void 0);
    ...
    return __async(this, null, function* () {
      ...
      try {
        ...
        const { db, auth } = yield __vitePreload(() => __async(this, null, function* () {
          const { db: db2, auth: auth2 } = yield import("./firebase-CDtyYuri.js").then((n) => n.f);
