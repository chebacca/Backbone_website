const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/firebase-CrF5P1Ck.js","assets/index-DXvUaEvN.js","assets/mui-DBh4ciAv.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-iYh_bQi1.js","assets/index-COak77tQ.css","assets/index.esm-zVCMB3Cx.js","assets/index.esm-CjtNHFZy.js","assets/index.esm-BMygn4u3.js","assets/UnifiedDataService-MypFdrQy.js","assets/FirestoreCollectionManager-BCB5eL4n.js"])))=>i.map(i=>d[i]);
...
const _FirestoreAdapter = class _FirestoreAdapter {
  ...
  initialize() {
    return __async(this, null, function* () {
      const firebase = yield __vitePreload(() => import("./firebase-CrF5P1Ck.js").then((n) => n.f), true ? __vite__mapDeps([0,1,2,3,4,5,6,7,8]) : void 0);
      this.db = firebase.db;
    ...
    return __async(this, null, function* () {
      try {
        ...
        const { db } = yield __vitePreload(() => __async(this, null, function* () {
          const { db: db2 } = yield import("./firebase-CrF5P1Ck.js").then((n) => n.f);
          return { db: db2 };
        }), true ? __vite__mapDeps([0,1,2,3,4,5,6,7,8]) : void 0);
    ...
    return __async(this, null, function* () {
      ...
      try {
        ...
        const { db, auth } = yield __vitePreload(() => __async(this, null, function* () {
          const { db: db2, auth: auth2 } = yield import("./firebase-CrF5P1Ck.js").then((n) => n.f);
