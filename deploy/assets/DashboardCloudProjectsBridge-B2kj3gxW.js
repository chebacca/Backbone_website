const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/DatasetCollectionValidator-BvP2No-q.js","assets/index-gdRn3Ffk.js","assets/mui-BbtiZaA3.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-rmDQXWB-.js","assets/index-COak77tQ.css","assets/index.esm-CjtNHFZy.js","assets/index.esm-zVCMB3Cx.js","assets/firebase-CF7wlbQ4.js","assets/index.esm-D5-7iBdy.js","assets/CloudProjectIntegration-CBw7vCA3.js","assets/UnifiedProjectCreationDialog-CWMSj8d9.js","assets/UnifiedDataService-BHEoO32F.js","assets/FirestoreCollectionManager-DREGoRSw.js"])))=>i.map(i=>d[i]);
...
import { g as getFunctions, h as httpsCallable, d as db } from "./firebase-CF7wlbQ4.js";
import { c as cloudProjectIntegration, T as TeamMemberRole, a as TeamMemberService } from "./CloudProjectIntegration-CBw7vCA3.js";
import { U as UnifiedProjectCreationDialog, s as simplifiedStartupSequencer } from "./UnifiedProjectCreationDialog-CWMSj8d9.js";
import { unifiedDataService } from "./UnifiedDataService-BHEoO32F.js";
  ...
  const handleSelectAll = reactExports.useCallback(() => __async(void 0, null, function* () {
    ...
    try {
      const { datasetCollectionValidator } = yield __vitePreload(() => __async(void 0, null, function* () {
        const { datasetCollectionValidator: datasetCollectionValidator2 } = yield import("./DatasetCollectionValidator-BvP2No-q.js");
      ...
      if (isTeamMember()) {
        try {
          ...
          const { db: db2 } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { db: db3 } = yield import("./firebase-CF7wlbQ4.js").then((n) => n.f);
            return { db: db3 };
