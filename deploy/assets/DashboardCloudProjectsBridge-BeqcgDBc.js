const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/DatasetCollectionValidator-DvKKnDTd.js","assets/index-_czX3gCs.js","assets/mui-Cc0LuBKd.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-CSTr_BWb.js","assets/index-COak77tQ.css","assets/index.esm-CjtNHFZy.js","assets/index.esm-zVCMB3Cx.js","assets/firebase-DqDGhmoM.js","assets/index.esm-D5-7iBdy.js","assets/CloudProjectIntegration-Ceg3mHeu.js","assets/UnifiedProjectCreationDialog-CCR6J0Kf.js","assets/UnifiedDataService-BTrDkuuN.js","assets/FirestoreCollectionManager-D492gjIj.js"])))=>i.map(i=>d[i]);
...
import { u as useAuth, b as authService, _ as __vitePreload, a as useLoading, E as ErrorBoundary } from "./index-_czX3gCs.js";
import { j as jsxRuntimeExports, au as Dialog, av as DialogTitle, B as Box, cp as ExtensionIcon, aw as DialogContent, bZ as Stepper, b_ as Step, b$ as StepLabel, d as Alert, T as Typography, ax as DialogActions, a as Button, C as CircularProgress, t as Card, w as CardContent, G as Grid, x as List, y as ListItem, z as ListItemIcon, a7 as StorageIcon, H as ListItemText, ae as Speed, J as Security, e as TextField, bS as AddIcon, a9 as FormControl, aa as InputLabel, ab as Select, M as MenuItem, g as IconButton, aA as DeleteIcon, Q as Accordion, U as AccordionSummary, W as ExpandMoreIcon, X as AccordionDetails, p as CheckCircleIcon, a0 as Info, r as Chip, Z as Business, Y as Group, b5 as Inventory, cq as MovieIcon, u as useTheme, aX as Settings, aH as Tabs, aI as Tab, cr as DatasetIcon, R as RefreshIcon, cs as GroupAddIcon, am as Table, an as TableHead, ao as TableRow, ap as TableCell, aq as TableBody, af as Avatar, aC as Tooltip, m as CheckIcon, ct as CancelIcon, bT as EditIcon, ar as MoreVertIcon, as as Menu, aN as ComputerIcon, c0 as NetworkIcon, N as CloudIcon, c as Paper, cu as CollectionsIcon, D as Divider, cv as CategoryIcon, cw as ExpandLessIcon, al as TableContainer, cx as SelectAllIcon, cy as DeselectAllIcon, bX as Collapse, l as Checkbox, F as FormControlLabel, s as Switch, I as InputAdornment, bV as ClearIcon, b4 as SearchIcon, cd as FilterList, $ as WarningIcon, V as VisibilityOff, h as Visibility, c3 as FormLabel, c4 as RadioGroup, c5 as Radio, bn as CloseIcon, i as LinearProgress, bx as Save, bE as PersonAddIcon, aR as DashboardIcon, cz as LightbulbIcon, az as ListItemSecondaryAction, c1 as Slider, A as ArrowBack, q as ArrowForward, v as Star, cA as EventIcon, aU as School, cB as SportsIcon, cC as TvIcon, cD as MusicIcon, cE as CampaignIcon, cF as ListItemAvatar, f as PersonIcon, cG as HelpIcon, a4 as Assessment, ak as TrendingUp, cH as ArchiveIcon, bB as Launch, cI as TableSortLabel, a_ as PlayArrow, cJ as StopIcon, cK as TablePagination, bY as Popover, c9 as StepContent, cL as CheckCircleOutlineIcon, aG as LinkIcon, a1 as PeopleIcon, a$ as Assignment, a2 as Schedule } from "./mui-Cc0LuBKd.js";
...
import { g as getFunctions, h as httpsCallable, d as db } from "./firebase-DqDGhmoM.js";
import { c as cloudProjectIntegration, T as TeamMemberRole, a as TeamMemberService } from "./CloudProjectIntegration-Ceg3mHeu.js";
import { U as UnifiedProjectCreationDialog, s as simplifiedStartupSequencer } from "./UnifiedProjectCreationDialog-CCR6J0Kf.js";
import { unifiedDataService } from "./UnifiedDataService-BTrDkuuN.js";
  ...
  const handleSelectAll = reactExports.useCallback(() => __async(void 0, null, function* () {
    ...
    try {
      const { datasetCollectionValidator } = yield __vitePreload(() => __async(void 0, null, function* () {
        const { datasetCollectionValidator: datasetCollectionValidator2 } = yield import("./DatasetCollectionValidator-DvKKnDTd.js");
      ...
      if (isTeamMember()) {
        try {
          ...
          const { db: db2 } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { db: db3 } = yield import("./firebase-DqDGhmoM.js").then((n) => n.f);
            return { db: db3 };
