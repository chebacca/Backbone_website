const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/DatasetCollectionValidator-DPMXSGod.js","assets/index-DXvUaEvN.js","assets/mui-DBh4ciAv.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-iYh_bQi1.js","assets/index-COak77tQ.css","assets/index.esm-CjtNHFZy.js","assets/index.esm-zVCMB3Cx.js","assets/firebase-CrF5P1Ck.js","assets/index.esm-BMygn4u3.js","assets/CloudProjectIntegration-DSurqUZl.js","assets/UnifiedProjectCreationDialog-gHlbY6C3.js","assets/UnifiedDataService-MypFdrQy.js","assets/FirestoreCollectionManager-BCB5eL4n.js"])))=>i.map(i=>d[i]);
...
import { u as useAuth, b as authService, _ as __vitePreload, a as useLoading, E as ErrorBoundary } from "./index-DXvUaEvN.js";
import { j as jsxRuntimeExports, at as Dialog, au as DialogTitle, B as Box, cn as ExtensionIcon, av as DialogContent, bX as Stepper, bY as Step, bZ as StepLabel, d as Alert, T as Typography, aw as DialogActions, a as Button, C as CircularProgress, t as Card, v as CardContent, G as Grid, w as List, x as ListItem, y as ListItemIcon, a6 as StorageIcon, z as ListItemText, ad as Speed, H as Security, e as TextField, bQ as AddIcon, a8 as FormControl, a9 as InputLabel, aa as Select, M as MenuItem, g as IconButton, az as DeleteIcon, O as Accordion, Q as AccordionSummary, U as ExpandMoreIcon, W as AccordionDetails, p as CheckCircleIcon, $ as Info, r as Chip, Y as Business, X as Group, b4 as Inventory, co as MovieIcon, bD as useTheme, aW as Settings, aG as Tabs, aH as Tab, cp as DatasetIcon, R as RefreshIcon, cq as GroupAddIcon, ak as TableContainer, c as Paper, al as Table, am as TableHead, an as TableRow, ao as TableCell, ap as TableBody, ae as Avatar, aB as Tooltip, m as CheckIcon, cr as CancelIcon, bR as EditIcon, aq as MoreVertIcon, ar as Menu, aM as ComputerIcon, b_ as NetworkIcon, K as CloudIcon, cs as CollectionsIcon, D as Divider, ct as CategoryIcon, cu as ExpandLessIcon, cv as SelectAllIcon, cw as DeselectAllIcon, bV as Collapse, l as Checkbox, F as FormControlLabel, s as Switch, I as InputAdornment, bT as ClearIcon, b3 as SearchIcon, cb as FilterList, _ as WarningIcon, V as VisibilityOff, h as Visibility, c1 as FormLabel, c2 as RadioGroup, c3 as Radio, bm as Close, i as LinearProgress, bu as Save, bB as PersonAddIcon, aQ as DashboardIcon, cx as LightbulbIcon, ay as ListItemSecondaryAction, b$ as Slider, A as ArrowBack, q as ArrowForward, u as Star, cy as EventIcon, aT as School, cz as SportsIcon, cA as TvIcon, cB as MusicIcon, cC as CampaignIcon, cD as ListItemAvatar, f as PersonIcon, cE as HelpIcon, a3 as Assessment, aj as TrendingUp, cF as ArchiveIcon, by as Launch, cG as TableSortLabel, aZ as PlayArrow, cH as StopIcon, cI as TablePagination, bW as Popover, c7 as StepContent, cJ as CheckCircleOutlineIcon, aF as LinkIcon, a0 as PeopleIcon, a_ as Assignment, a1 as Schedule } from "./mui-DBh4ciAv.js";
...
import { g as getFunctions, h as httpsCallable, d as db } from "./firebase-CrF5P1Ck.js";
import { c as cloudProjectIntegration, T as TeamMemberRole, a as TeamMemberService } from "./CloudProjectIntegration-DSurqUZl.js";
import { U as UnifiedProjectCreationDialog, s as simplifiedStartupSequencer } from "./UnifiedProjectCreationDialog-gHlbY6C3.js";
import { unifiedDataService } from "./UnifiedDataService-MypFdrQy.js";
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Card,
              {
                ...
                children: [
                  ...
                  projectTeamMembers.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(TableContainer, { component: Paper, sx: {
                    borderRadius: theme.shape.borderRadius,
                    background: theme.palette.background.paper,
                    border: `1px solid ${theme.palette.divider}`,
                    boxShadow: theme.shadows[2]
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: projectTeamMembers.map((member) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      TableRow,
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", sx: {
                            color: theme.palette.text.secondary
                          }, children: member.email || "No email" }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: editingMemberId === member.id ? /* @__PURE__ */ jsxRuntimeExports.jsx(FormControl, { size: "small", sx: { minWidth: 120 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            Select,
                            {
                              value: editingRole,
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: editingMemberId === member.id ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                            TextField,
                            {
                              size: "small",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { sx: { textAlign: "center" }, children: editingMemberId === member.id ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", gap: 1, justifyContent: "center" }, children: [
  ...
  const handleSelectAll = reactExports.useCallback(() => __async(void 0, null, function* () {
    ...
    try {
      const { datasetCollectionValidator } = yield __vitePreload(() => __async(void 0, null, function* () {
        const { datasetCollectionValidator: datasetCollectionValidator2 } = yield import("./DatasetCollectionValidator-DPMXSGod.js");
  ...
  const renderCreateCustom = () => /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { mb: 3, display: "flex", alignItems: "center", gap: 1 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          startIcon: /* @__PURE__ */ jsxRuntimeExports.jsx(Close, {}),
...
const DashboardCloudProjectsBridge = () => {
  ...
  const fetchSubscriptionData = reactExports.useCallback((organizationId) => __async(void 0, null, function* () {
    ...
    try {
      ...
      const { getAuth } = yield __vitePreload(() => __async(void 0, null, function* () {
        const { getAuth: getAuth2 } = yield import("./index.esm-BMygn4u3.js");
  ...
  const canCreateProjects = reactExports.useCallback(() => {
    var _a2, _b2, _c2, _d2;
    if (!completeUser) {
  ...
  reactExports.useCallback((projectList) => __async(void 0, null, function* () {
    try {
      ...
      const teamMemberCountPromises = projectList.map((project) => __async(void 0, null, function* () {
        try {
          const teamMembers = yield cloudProjectIntegration.getProjectTeamMembers(project.id);
          return { projectId: project.id, count: teamMembers.length };
        } catch (error2) {
          console.warn(`⚠️ [DashboardCloudProjectsBridge] Failed to load team members for project ${project.id}:`, error2);
          return { projectId: project.id, count: 0 };
        }
      }));
      const teamMemberCounts = yield Promise.all(teamMemberCountPromises);
      const newCounts = {};
      ...
      if (isTeamMember()) {
        try {
          ...
          const { db: db2 } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { db: db3 } = yield import("./firebase-CrF5P1Ck.js").then((n) => n.f);
            return { db: db3 };
          ...
          yield loadDatasetCountsForAllProjects(transformedProjects);
          ...
          if (teamMemberData) {
            try {
              ...
              if (parsed.projectAccess && Array.isArray(parsed.projectAccess)) {
                ...
                yield loadDatasetCountsForAllProjects(fallbackProjects);
                return;
              }
            } catch (parseError) {
        ...
        const teamMemberCountPromises = serviceProjects.map((project) => __async(void 0, null, function* () {
          try {
            const teamMembers = yield cloudProjectIntegration.getProjectTeamMembers(project.id);
            return { projectId: project.id, count: teamMembers.length };
          } catch (error2) {
        ...
        const datasetCountPromises = serviceProjects.map((project) => __async(void 0, null, function* () {
          try {
            const datasets = yield cloudProjectIntegration.getProjectDatasets(project.id);
            return { projectId: project.id, count: datasets.length };
          } catch (error2) {
        ...
        const [teamMemberCounts, datasetCounts] = yield Promise.all([
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: paginatedProjects.map((project) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                TableRow,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: typeof projectDatasetCounts[project.id] === "number" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Chip,
                      {
                        size: "small",
                        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(DatasetIcon, {}),
