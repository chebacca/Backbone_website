const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/DatasetCollectionValidator-C4-UPGnJ.js","assets/index-CDEjieLs.js","assets/mui-DKIosbOx.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-CqWXfGEZ.js","assets/index-COak77tQ.css","assets/index.esm-CjtNHFZy.js","assets/index.esm-zVCMB3Cx.js","assets/firebase-BmlabmcF.js","assets/index.esm-D5-7iBdy.js","assets/CloudProjectIntegration-DJPudBAA.js","assets/UnifiedProjectCreationDialog-CCbJc8Ap.js","assets/UnifiedDataService-Z6JZvpaS.js","assets/FirestoreCollectionManager-Bk1iX8vZ.js"])))=>i.map(i=>d[i]);
...
import { u as useAuth, b as authService, _ as __vitePreload, a as useLoading, E as ErrorBoundary } from "./index-CDEjieLs.js";
import { j as jsxRuntimeExports, a4 as Dialog, a5 as DialogTitle, B as Box, cu as ExtensionIcon, a7 as DialogContent, _ as Stepper, $ as Step, a0 as StepLabel, d as Alert, T as Typography, aD as DialogActions, a as Button, C as CircularProgress, t as Card, w as CardContent, G as Grid, x as List, y as ListItem, z as ListItemIcon, ah as StorageIcon, H as ListItemText, ao as Speed, J as Security, e as TextField, bK as AddIcon, aj as FormControl, ak as InputLabel, al as Select, M as MenuItem, g as IconButton, aG as DeleteIcon, Q as Accordion, U as AccordionSummary, W as ExpandMoreIcon, X as AccordionDetails, p as CheckCircleIcon, ac as InfoIcon, r as Chip, Z as Business, Y as Group, b6 as Inventory, cv as MovieIcon, u as useTheme, aY as Settings, aQ as Tabs, aR as Tab, cw as DatasetIcon, R as RefreshIcon, cx as GroupAddIcon, aw as Table, ax as TableHead, ay as TableRow, az as TableCell, aA as TableBody, ap as Avatar, aI as Tooltip, m as CheckIcon, cy as CancelIcon, c1 as EditIcon, aB as MoreVertIcon, aC as Menu, aM as ComputerIcon, c2 as NetworkIcon, N as CloudIcon, c as Paper, cz as CollectionsIcon, D as Divider, cA as CategoryIcon, cB as ExpandLessIcon, av as TableContainer, cC as SelectAllIcon, cD as DeselectAllIcon, cc as Collapse, l as Checkbox, F as FormControlLabel, s as Switch, I as InputAdornment, ca as ClearIcon, b5 as SearchIcon, ck as FilterList, ab as WarningIcon, V as VisibilityOff, h as Visibility, c5 as FormLabel, c6 as RadioGroup, c7 as Radio, a6 as CloseIcon, i as LinearProgress, bz as Save, bG as PersonAddIcon, aS as DashboardIcon, cE as LightbulbIcon, aF as ListItemSecondaryAction, c3 as Slider, A as ArrowBack, q as ArrowForward, v as Star, cF as EventIcon, aV as School, cG as SportsIcon, cH as TvIcon, cI as MusicIcon, cJ as CampaignIcon, cK as ListItemAvatar, f as PersonIcon, cL as HelpIcon, af as Assessment, au as TrendingUp, cM as ArchiveIcon, bD as Launch, cN as TableSortLabel, a$ as PlayArrow, cO as StopIcon, aP as TablePagination, cd as Popover, cf as StepContent, cP as CheckCircleOutlineIcon, cQ as LinkIcon, ad as PeopleIcon, b0 as Assignment, a9 as Schedule } from "./mui-DKIosbOx.js";
...
import { g as getFunctions, h as httpsCallable, d as db } from "./firebase-BmlabmcF.js";
import { c as cloudProjectIntegration, T as TeamMemberRole, a as TeamMemberService } from "./CloudProjectIntegration-DJPudBAA.js";
import { U as UnifiedProjectCreationDialog, s as simplifiedStartupSequencer } from "./UnifiedProjectCreationDialog-CCbJc8Ap.js";
import { unifiedDataService } from "./UnifiedDataService-Z6JZvpaS.js";
  ...
  const handleSelectAll = reactExports.useCallback(() => __async(void 0, null, function* () {
    ...
    try {
      const { datasetCollectionValidator } = yield __vitePreload(() => __async(void 0, null, function* () {
        const { datasetCollectionValidator: datasetCollectionValidator2 } = yield import("./DatasetCollectionValidator-C4-UPGnJ.js");
      ...
      if (isTeamMember()) {
        try {
          ...
          const { db: db2 } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { db: db3 } = yield import("./firebase-BmlabmcF.js").then((n) => n.f);
            return { db: db3 };
