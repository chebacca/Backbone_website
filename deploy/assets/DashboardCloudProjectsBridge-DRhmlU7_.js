const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/DatasetCollectionValidator-CS9PJgDN.js","assets/index-Dx2eHdQc.js","assets/mui-gCwp_wLb.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-Dk1a53Oq.js","assets/index-COak77tQ.css","assets/index.esm-CjtNHFZy.js","assets/index.esm-zVCMB3Cx.js","assets/firebase-CEoxMprK.js","assets/index.esm-D5-7iBdy.js","assets/CloudProjectIntegration-CDazdXFY.js","assets/UnifiedProjectCreationDialog-CktLy0S6.js","assets/UnifiedDataService-7IfqOsH7.js","assets/FirestoreCollectionManager-CqiOiVWu.js"])))=>i.map(i=>d[i]);
...
import { g as getFunctions, h as httpsCallable, d as db } from "./firebase-CEoxMprK.js";
import { c as cloudProjectIntegration, T as TeamMemberRole, a as TeamMemberService } from "./CloudProjectIntegration-CDazdXFY.js";
import { U as UnifiedProjectCreationDialog, s as simplifiedStartupSequencer } from "./UnifiedProjectCreationDialog-CktLy0S6.js";
import { unifiedDataService } from "./UnifiedDataService-7IfqOsH7.js";
  ...
  const handleSelectAll = reactExports.useCallback(() => __async(void 0, null, function* () {
    ...
    try {
      const { datasetCollectionValidator } = yield __vitePreload(() => __async(void 0, null, function* () {
        const { datasetCollectionValidator: datasetCollectionValidator2 } = yield import("./DatasetCollectionValidator-CS9PJgDN.js");
      ...
      if (isTeamMember()) {
        try {
          ...
          const { db: db2 } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { db: db3 } = yield import("./firebase-CEoxMprK.js").then((n) => n.f);
            return { db: db3 };
