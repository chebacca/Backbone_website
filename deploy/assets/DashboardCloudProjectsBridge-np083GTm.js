const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/DatasetCollectionValidator-BfxIVMh1.js","assets/index-CapzkfpX.js","assets/mui-BoeRORKC.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-Luo-7hoF.js","assets/index-COak77tQ.css","assets/index.esm-CjtNHFZy.js","assets/index.esm-zVCMB3Cx.js","assets/firebase-ddg95FKg.js","assets/index.esm-D5-7iBdy.js","assets/CloudProjectIntegration-DO_zVFdF.js","assets/UnifiedProjectCreationDialog-DaH5-90r.js","assets/UnifiedDataService-CpI3FjvA.js","assets/FirestoreCollectionManager-BmICfP04.js"])))=>i.map(i=>d[i]);
...
import { u as useAuth, b as authService, _ as __vitePreload, a as useLoading, E as ErrorBoundary } from "./index-CapzkfpX.js";
import { j as jsxRuntimeExports, at as Dialog, au as DialogTitle, B as Box, cp as ExtensionIcon, av as DialogContent, bX as Stepper, bY as Step, bZ as StepLabel, d as Alert, T as Typography, aw as DialogActions, a as Button, C as CircularProgress, t as Card, v as CardContent, G as Grid, w as List, x as ListItem, y as ListItemIcon, a6 as StorageIcon, z as ListItemText, ad as Speed, H as Security, e as TextField, bQ as AddIcon, a8 as FormControl, a9 as InputLabel, aa as Select, M as MenuItem, g as IconButton, az as DeleteIcon, O as Accordion, Q as AccordionSummary, U as ExpandMoreIcon, W as AccordionDetails, p as CheckCircleIcon, $ as Info, r as Chip, Y as Business, X as Group, b4 as Inventory, cq as MovieIcon, bD as useTheme, aW as Settings, aG as Tabs, aH as Tab, cr as DatasetIcon, R as RefreshIcon, cs as GroupAddIcon, al as Table, am as TableHead, an as TableRow, ao as TableCell, ap as TableBody, ae as Avatar, aB as Tooltip, m as CheckIcon, ct as CancelIcon, bR as EditIcon, aq as MoreVertIcon, ar as Menu, aM as ComputerIcon, b_ as NetworkIcon, K as CloudIcon, c as Paper, cu as CollectionsIcon, D as Divider, cv as CategoryIcon, cw as ExpandLessIcon, ak as TableContainer, cx as SelectAllIcon, cy as DeselectAllIcon, bV as Collapse, l as Checkbox, F as FormControlLabel, s as Switch, I as InputAdornment, bT as ClearIcon, b3 as SearchIcon, cb as FilterList, _ as WarningIcon, V as VisibilityOff, h as Visibility, c1 as FormLabel, c2 as RadioGroup, c3 as Radio, bm as CloseIcon, i as LinearProgress, bu as Save, bB as PersonAddIcon, aQ as DashboardIcon, cz as LightbulbIcon, ay as ListItemSecondaryAction, b$ as Slider, A as ArrowBack, q as ArrowForward, u as Star, cA as EventIcon, aT as School, cB as SportsIcon, cC as TvIcon, cD as MusicIcon, cE as CampaignIcon, cF as ListItemAvatar, f as PersonIcon, cG as HelpIcon, a3 as Assessment, aj as TrendingUp, cH as ArchiveIcon, by as Launch, cI as TableSortLabel, aZ as PlayArrow, cJ as StopIcon, cK as TablePagination, bW as Popover, c7 as StepContent, cL as CheckCircleOutlineIcon, aF as LinkIcon, a0 as PeopleIcon, a_ as Assignment, a1 as Schedule } from "./mui-BoeRORKC.js";
...
import { g as getFunctions, h as httpsCallable, d as db } from "./firebase-ddg95FKg.js";
import { c as cloudProjectIntegration, T as TeamMemberRole, a as TeamMemberService } from "./CloudProjectIntegration-DO_zVFdF.js";
import { U as UnifiedProjectCreationDialog, s as simplifiedStartupSequencer } from "./UnifiedProjectCreationDialog-DaH5-90r.js";
import { unifiedDataService } from "./UnifiedDataService-CpI3FjvA.js";
  ...
  const handleSelectAll = reactExports.useCallback(() => __async(void 0, null, function* () {
    ...
    try {
      const { datasetCollectionValidator } = yield __vitePreload(() => __async(void 0, null, function* () {
        const { datasetCollectionValidator: datasetCollectionValidator2 } = yield import("./DatasetCollectionValidator-BfxIVMh1.js");
      ...
      if (isTeamMember()) {
        try {
          ...
          const { db: db2 } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { db: db3 } = yield import("./firebase-ddg95FKg.js").then((n) => n.f);
            return { db: db3 };
