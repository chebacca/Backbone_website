const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index.esm-D5-7iBdy.js","assets/index.esm-zVCMB3Cx.js"])))=>i.map(i=>d[i]);
...
import { j as jsxRuntimeExports, aI as Tooltip, g as IconButton, bH as Badge, J as Security, u as useTheme, bQ as useMediaQuery, B as Box, bR as AppBar, bS as Toolbar, bT as MenuIcon, A as ArrowBack, a as Button, aH as Notifications, bU as AccountCircle, aC as Menu, M as MenuItem, z as ListItemIcon, aY as Settings, bV as Logout, bW as Drawer, aS as DashboardIcon, a2 as PaymentIcon, an as Analytics, bX as AccountBalance, bk as Description, Y as Group, ae as CardMembership, a3 as Download, bY as Store, K as Support, T as Typography, ap as Avatar, r as Chip, x as List, y as ListItem, bZ as ListItemButton, H as ListItemText, D as Divider, Z as Business, at as Receipt } from "./mui-DKIosbOx.js";
import { u as useNavigate, r as reactExports, e as useLocation, b as React, L as Link, O as Outlet } from "./vendor-Cu2L4Rr-.js";
import { u as useAuth, _ as __vitePreload, R as RoleBasedAccessControl } from "./index-DPkTu3FI.js";
import { T as ThemeToggle } from "./ThemeToggle-9ZFbUmS1.js";
...
const standaloneNavigationItems = [
  ...
  { text: "Marketplace", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Store, {}), path: "/marketplace" },
