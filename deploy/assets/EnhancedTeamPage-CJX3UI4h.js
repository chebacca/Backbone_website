...
const FirebaseOnlyInviteTeamMemberDialog = ({
  ...
  const handleSubmit = () => __async(void 0, null, function* () {
    ...
    try {
      ...
      enqueueSnackbar("Team member created successfully using Firebase! The table will refresh automatically.", { variant: "success" });
      onSuccess(result);
      onClose();
    } catch (error) {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogActions, { sx: { p: 3 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: loading ? "Creating..." : "Create Team Member (Firebase-Only)"
            }
          )
        ] })
      ]
