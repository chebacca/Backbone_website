...
const EnhancedTeamPage = React.memo(() => {
  ...
  const handleConfirmDeleteMember = reactExports.useCallback(() => {
    var _a2;
    if (!selectedMember) return;
    ...
    setTimeout(() => __async(void 0, null, function* () {
      try {
        ...
        console.error("❌ [EnhancedTeamPage] Error refreshing data after removal:", error);
      }
    }), 1e3);
