...
const FirebaseOnlyInviteTeamMemberDialog = ({
  ...
  const handleSubmit = () => __async(void 0, null, function* () {
    ...
    try {
      ...
      enqueueSnackbar("Team member created successfully using Firebase!", { variant: "success" });
      onSuccess(result);
      onClose();
    } catch (error) {
