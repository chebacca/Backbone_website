...
import { j as jsxRuntimeExports, at as Dialog, au as DialogTitle, B as Box, bB as PersonAddIcon, T as Typography, g as IconButton, bm as CloseIcon, av as DialogContent, d as Alert, G as Grid, e as TextField, I as InputAdornment, E as EmailIcon, a8 as FormControl, a9 as InputLabel, aa as Select, M as MenuItem, V as VisibilityOff, h as Visibility, a as Button, aw as DialogActions, C as CircularProgress, aD as Skeleton, Z as AlertTitle, R as RefreshIcon, as as Download, ca as Upload, a0 as PeopleIcon, p as CheckCircleIcon, a1 as Schedule, bS as LicenseIcon, t as Card, v as CardContent, b3 as SearchIcon, cb as FilterList, bO as CardHeader, ak as TableContainer, c as Paper, al as Table, am as TableHead, an as TableRow, ao as TableCell, l as Checkbox, ap as TableBody, ae as Avatar, r as Chip, aq as MoreVertIcon, cc as Pagination, ar as Menu, y as ListItemIcon, bR as EditIcon, u as Star, L as Lock, D as Divider, az as DeleteIcon } from "./mui-BbtiZaA3.js";
import { r as reactExports, b as React } from "./vendor-Cu2L4Rr-.js";
import { u as useSnackbar } from "./notistack.esm-DLh02w5s.js";
import { b as useCurrentUser, c as useOrganizationContext, a as useOrganizationTeamMembers, u as useOrganizationLicenses, d as useUserProjects, i as useInviteTeamMember, j as useUpdateTeamMember, k as useRemoveTeamMember, g as useAssignLicense, h as useUnassignLicense, l as useChangeTeamMemberPassword } from "./useStreamlinedData-0zDxlAhJ.js";
import { M as MetricCard } from "./MetricCard-DT0TWtTD.js";
import { d as db, a as auth } from "./firebase-B5NzQZM2.js";
  ...
  const handleSubmit = () => __async(void 0, null, function* () {
    ...
    try {
      ...
      const teamMemberData = {
        ...
        assignedLicenseKey: selectedLicense.key
      };
      ...
      enqueueSnackbar(`Team member created successfully and assigned license ${selectedLicense.key}! The table will refresh automatically.`, { variant: "success" });
      onSuccess(result);
      onClose();
    } catch (error) {
...
const EnhancedTeamPage = React.memo(() => {
  ...
  const handleConfirmDeleteMember = reactExports.useCallback(() => __async(void 0, null, function* () {
    if (!selectedMember) return;
    try {
      console.log("🗑️ [EnhancedTeamPage] Removing team member:", selectedMember.email);
      const hasAssignedLicense = selectedMember.assignedLicenseId || selectedMember.licenseType;
      yield removeTeamMember.mutateAsync({ memberId: selectedMember.id });
      ...
      console.error("❌ [EnhancedTeamPage] Failed to remove team member:", error);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { p: 3 }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open: deleteMemberDialogOpen, onClose: () => setDeleteMemberDialogOpen(false), maxWidth: "sm", fullWidth: true, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { mt: 2 }, children: [
        ...
        selectedMember && (selectedMember.assignedLicenseId || selectedMember.licenseType) && /* @__PURE__ */ jsxRuntimeExports.jsxs(Alert, { severity: "info", sx: { mb: 2 }, children: [
