...
import { cr as interopRequireDefaultExports, j as jsxRuntimeExports, u as useTheme, a4 as Dialog, a5 as DialogTitle, B as Box, T as Typography, a7 as DialogContent, r as Chip, d as Alert, e as TextField, F as FormControlLabel, k as Link, l as Checkbox, D as Divider, x as List, y as ListItem, z as ListItemIcon, H as ListItemText, aD as DialogActions, a as Button, C as CircularProgress, b as Container, G as Grid, S as Stack, p as CheckCircleIcon, cu as RocketLaunch$1, c as Paper, g as IconButton, b3 as PlayArrow, t as Card, w as CardContent, v as Star$1, a1 as ShoppingCart, bM as Snackbar, aQ as VideoLibrary, Y as Group, J as Security, ao as Speed, K as Support } from "./mui-kQ2X8N0A.js";
import { r as reactExports, u as useNavigate } from "./vendor-Cu2L4Rr-.js";
import { r as requireCreateSvgIcon, N as Navigation } from "./Navigation-Cswg7BXE.js";
...
const LandingPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { backgroundColor: "background.default", minHeight: "100vh" }, children: [
    ...
    isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { sx: { backgroundColor: "background.paper", py: { xs: 8, md: 12 } }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Container, { maxWidth: "lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { textAlign: "center", sx: { mb: 8 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Typography,
        {
          variant: "h2",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Typography,
        {
          ...
          children: "Explore our marketplace of professional tools and add-ons to enhance your workflow"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          variant: "contained",
          size: "large",
          startIcon: /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, {}),
