...
import { ck as interopRequireDefaultExports, j as jsxRuntimeExports, bF as useTheme, at as Dialog, au as DialogTitle, B as Box, T as Typography, av as DialogContent, r as Chip, d as Alert, e as TextField, F as FormControlLabel, k as Link, l as Checkbox, D as Divider, w as List, x as ListItem, y as ListItemIcon, z as ListItemText, aw as DialogActions, a as Button, C as CircularProgress, b as Container, G as Grid, S as Stack, p as CheckCircleIcon, cn as RocketLaunch$1, c as Paper, g as IconButton, aZ as PlayArrow, t as Card, v as CardContent, u as Star$1, co as Snackbar, a$ as VideoLibrary, X as Group, H as Security, ad as Speed, J as Support } from "./mui-CLBPY2Ik.js";
import { r as reactExports, u as useNavigate } from "./vendor-Cu2L4Rr-.js";
import { r as requireCreateSvgIcon, N as Navigation } from "./Navigation-SSoHOqMD.js";
import { F as Footer } from "./Footer-DrNBa4Wg.js";
import { u as useAuth } from "./index-DEqQZsU9.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Dialog,
    {
      ...
      PaperProps: {
        sx: {
          borderRadius: 2,
          background: `linear-gradient(135deg, ${theme2.palette.background.paper} 0%, ${theme2.palette.background.default} 100%)`
        }
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { sx: { pb: 1 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", gap: 1 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(default_1$2, { sx: { color: theme2.palette.primary.main, fontSize: 28 } }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", gap: 3, mb: 3 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { flex: 1 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "h6", sx: { mb: 1, color: theme2.palette.primary.main }, children: "Demo Registration" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { flex: 1 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "h6", sx: { mb: 1, color: theme2.palette.success.main }, children: "Demo Features Included" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(List, { dense: true, children: DEMO_FEATURES.map((feature, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(ListItem, { sx: { py: 0.25 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ListItemIcon, { sx: { minWidth: 32 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(default_1$3, { sx: { fontSize: 16, color: theme2.palette.success.main } }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ListItemText,
                  {
                    primary: feature,
      ...
      Paper,
      {
        ...
        children: [
          ...
          !hasActiveAccess && /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { mt: 4, display: "flex", alignItems: "center", justifyContent: "center", gap: 2 }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", color: "text.secondary", children: "No credit card required • 14-day free trial • Cancel anytime" })
          ] }),
          hasActiveAccess && /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { mt: 4, display: "flex", alignItems: "center", justifyContent: "center", gap: 2 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircleIcon, { sx: { color: "success.main", fontSize: 20 } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", color: "text.secondary", children: "Active subscription • Full access • Premium support" })
          ] })
        ]
      }
    ) }) }),
