const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/UnifiedDataService-DnVuuCLO.js","assets/index-Dd1DWJhm.js","assets/mui-BbtiZaA3.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-rmDQXWB-.js","assets/index-COak77tQ.css","assets/index.esm-CjtNHFZy.js","assets/index.esm-zVCMB3Cx.js","assets/FirestoreCollectionManager-C4RhxpKp.js","assets/firebase-OW2Ef77O.js","assets/index.esm-BMygn4u3.js"])))=>i.map(i=>d[i]);
...
import { j as jsxRuntimeExports, at as Dialog, au as DialogTitle, B as Box, c5 as ShoppingCart, T as Typography, g as IconButton, bm as CloseIcon, av as DialogContent, bX as Stepper, bY as Step, bZ as StepLabel, aw as DialogActions, a as Button, A as ArrowBack, q as ArrowForward, p as CheckCircleIcon, t as Card, v as CardContent, G as Grid, as as Download, c6 as Key, D as Divider, r as Chip, w as List, x as ListItem, y as ListItemIcon, z as ListItemText, e as TextField, L as Lock, d as Alert, Z as AlertTitle, C as CircularProgress, ag as CreditCard, R as RefreshIcon, c7 as StepContent, a8 as FormControl, a9 as InputLabel, aa as Select, M as MenuItem, F as FormControlLabel, l as Checkbox, ak as TableContainer, c as Paper, al as Table, am as TableHead, an as TableRow, ao as TableCell, ap as TableBody, ae as Avatar, _ as WarningIcon, H as Security, bQ as AddIcon, u as Star, a2 as CardMembership, bN as BlockIcon, aq as MoreVertIcon, c8 as Fab, bB as PersonAddIcon, az as DeleteIcon, bR as EditIcon, I as InputAdornment, a1 as Schedule, a_ as Assignment, a0 as PeopleIcon, i as LinearProgress, E as EmailIcon, Y as Business, c9 as AccessTime, ar as Menu, aE as ContentCopy } from "./mui-BbtiZaA3.js";
import { r as reactExports } from "./vendor-Cu2L4Rr-.js";
import { b as useCurrentUser, c as useOrganizationContext, u as useOrganizationLicenses, a as useOrganizationTeamMembers, f as useUpdateLicense, g as useAssignLicense, h as useUnassignLicense } from "./useStreamlinedData-BtYc-B_y.js";
import { _ as __vitePreload } from "./index-Dd1DWJhm.js";
import { u as useSnackbar } from "./notistack.esm-DLh02w5s.js";
import { E as Elements, l as loadStripe, u as useStripe, a as useElements, C as CardElement } from "./stripe-rmDQXWB-.js";
import "./UnifiedDataService-DnVuuCLO.js";
import "./index.esm-CjtNHFZy.js";
import "./index.esm-zVCMB3Cx.js";
import "./FirestoreCollectionManager-C4RhxpKp.js";
import "./firebase-OW2Ef77O.js";
...
const LicensesPage = () => {
  ...
  const licenseData = reactExports.useMemo(() => {
    ...
    const organizationOwnerCount = 1;
    const ownerEmail = currentUser == null ? void 0 : currentUser.email;
    const teamMemberCount = teamMembers ? teamMembers.filter(
      (m) => {
        var _a2;
        return ((_a2 = m.status) == null ? void 0 : _a2.toLowerCase()) === "active" && m.email !== ownerEmail;
      }
    ).length : 0;
    const ownerAssignedLicenses = licenses ? licenses.filter(
      (l) => {
        var _a2;
        return l.status === "ACTIVE" && ((_a2 = l.assignedTo) == null ? void 0 : _a2.email) === ownerEmail;
      }
    ).length : 0;
    console.log("🔍 [LicensesPage] Raw data for calculation:", {
      ...
      licenses: (licenses == null ? void 0 : licenses.map((l) => ({ id: l.id, name: l.name, status: l.status, assignedTo: l.assignedTo }))) || [],
    ...
    console.log("🔢 [LicensesPage] License calculation breakdown:", {
      ...
      usedLicenses,
      totalTeamMembers: (teamMembers == null ? void 0 : teamMembers.length) || 0,
    ...
    const enterpriseAssigned = usedLicenses;
