const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index.esm-BMygn4u3.js","assets/index.esm-zVCMB3Cx.js"])))=>i.map(i=>d[i]);
...
import { j as jsxRuntimeExports, at as Dialog, au as DialogTitle, B as Box, c5 as ShoppingCart, T as Typography, g as IconButton, bm as Close, av as DialogContent, bX as Stepper, bY as Step, bZ as StepLabel, aw as DialogActions, a as Button, A as ArrowBack, q as ArrowForward, p as CheckCircleIcon, t as Card, v as CardContent, G as Grid, as as Download, c6 as Key, D as Divider, r as Chip, w as List, x as ListItem, y as ListItemIcon, z as ListItemText, e as TextField, L as Lock, d as Alert, Z as AlertTitle, C as CircularProgress, ag as CreditCard, R as RefreshIcon, c7 as StepContent, a8 as FormControl, a9 as InputLabel, aa as Select, M as MenuItem, F as FormControlLabel, l as Checkbox, ak as TableContainer, c as Paper, al as Table, am as TableHead, an as TableRow, ao as TableCell, ap as TableBody, ae as Avatar, _ as WarningIcon, H as Security, bQ as AddIcon, u as Star, a2 as CardMembership, bN as BlockIcon, aq as MoreVertIcon, c8 as Fab, bB as PersonAddIcon, az as DeleteIcon, bR as EditIcon, I as InputAdornment, a1 as Schedule, a_ as Assignment, a0 as PeopleIcon, i as LinearProgress, E as Email, Y as Business, c9 as AccessTime, ar as Menu, aE as ContentCopy } from "./mui-DBh4ciAv.js";
import { r as reactExports } from "./vendor-Cu2L4Rr-.js";
import { b as useCurrentUser, c as useOrganizationContext, u as useOrganizationLicenses, a as useOrganizationTeamMembers, f as useUpdateLicense, g as useAssignLicense, h as useUnassignLicense } from "./useStreamlinedData-Dj54o78Y.js";
import { _ as __vitePreload } from "./index-DhGsANuG.js";
import { u as useSnackbar } from "./notistack.esm-DLh02w5s.js";
import { E as Elements, l as loadStripe, u as useStripe, a as useElements, C as CardElement } from "./stripe-iYh_bQi1.js";
import "./UnifiedDataService-rK0HwDUf.js";
import "./index.esm-CjtNHFZy.js";
import "./index.esm-zVCMB3Cx.js";
import "./FirestoreCollectionManager-D3JS9wCr.js";
import "./firebase-DARisV-i.js";
...
const LicensePurchaseFlow = ({
  ...
  const handlePaymentSuccess = (paymentMethod) => __async(void 0, null, function* () {
    ...
    try {
      ...
      const response = yield fetch("/api/licenses/purchase", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${yield getAuthToken2()}`
          // Implement this
        },
        body: JSON.stringify({
  ...
  const getAuthToken2 = () => __async(void 0, null, function* () {
    try {
    ...
    Dialog,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton, { onClick: handleClose, disabled: processing, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Close, {}) })
        ] }) }),
