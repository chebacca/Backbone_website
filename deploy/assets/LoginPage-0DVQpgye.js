const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CGrdxgLC.js","assets/mui-BbtiZaA3.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-rmDQXWB-.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
...
import { u as useAuth, a as useLoading, _ as __vitePreload } from "./index-CGrdxgLC.js";
                ...
                onClick: () => __async(void 0, null, function* () {
                  ...
                  try {
                    ...
                    const { verify2FA } = (yield __vitePreload(() => __async(void 0, null, function* () {
                      const { authService } = yield import("./index-CGrdxgLC.js").then((n) => n.f);
                      return { authService };
