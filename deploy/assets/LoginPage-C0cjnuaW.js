const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DHDSU-2u.js","assets/mui-kQ2X8N0A.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-TEyM19uV.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
...
import { u as useAuth, a as useLoading, _ as __vitePreload } from "./index-DHDSU-2u.js";
                ...
                onClick: () => __async(void 0, null, function* () {
                  ...
                  try {
                    ...
                    const { verify2FA } = (yield __vitePreload(() => __async(void 0, null, function* () {
                      const { authService } = yield import("./index-DHDSU-2u.js").then((n) => n.g);
                      return { authService };
