const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DEqQZsU9.js","assets/mui-CLBPY2Ik.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-B5XG1UK0.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
...
import { u as useAuth, a as useLoading, _ as __vitePreload } from "./index-DEqQZsU9.js";
                ...
                onClick: () => __async(void 0, null, function* () {
                  ...
                  try {
                    ...
                    const { verify2FA } = (yield __vitePreload(() => __async(void 0, null, function* () {
                      const { authService } = yield import("./index-DEqQZsU9.js").then((n) => n.g);
                      return { authService };
