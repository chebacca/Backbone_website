...
const products = [
  {
    ...
    description: "Professional video editing suite with advanced timeline controls, multi-camera editing, and AI-powered color correction. Perfect for professional content creators and studios.",
  ...
  },
  {
    ...
    description: "Advanced audio production toolkit with professional-grade mixing, mastering, and sound design capabilities. Includes 50+ high-quality audio effects and instruments.",
  ...
  },
  {
    ...
    description: "Create stunning motion graphics and animations with our intuitive timeline-based editor. Perfect for title sequences, lower thirds, and animated graphics.",
  ...
  },
  {
    ...
    description: "Professional color grading and correction tool with advanced color wheels, curves, and AI-powered auto-correction. Achieve cinematic looks with ease.",
  ...
  },
  {
    ...
    description: "Complete streaming solution with multi-platform broadcasting, scene composition, and real-time effects. Perfect for content creators and live streamers.",
  ...
  },
  {
    ...
    description: "Comprehensive project management tool designed specifically for creative teams. Track progress, manage assets, and collaborate seamlessly.",
  ...
  const ProductCard = ({ product }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Zoom, { in: true, timeout: 300, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Card,
    {
      ...
      children: [
              ...
              children: [
                ...
                product.originalPrice && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Chip,
                  {
                    ...
                    color: "error",
                    size: "small",
                    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(LocalOffer, {})
                  }
                )
              ]
            }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardActions, { sx: { p: 3, pt: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", spacing: 2, sx: { width: "100%" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              variant: "outlined",
