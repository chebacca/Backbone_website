...
import { u as useTheme, j as jsxRuntimeExports, B as Box, t as Card, w as CardContent, a1 as ShoppingCart, T as Typography, S as Stack, r as Chip, p as CheckCircleIcon, D as Divider, d as Alert, e as TextField, f as PersonIcon, E as EmailIcon, L as Lock, a as Button, b as Container, bH as Badge, bI as ShoppingBag, G as Grid, a4 as Dialog, a5 as DialogTitle, g as IconButton, a6 as CloseIcon, a7 as DialogContent, c as Paper, bJ as Remove, bK as AddIcon, aD as DialogActions, a2 as PaymentIcon, bL as Snackbar, bM as Zoom, bN as CardMedia, v as Star, bO as Rating, a3 as Download, bP as CardActions, ac as InfoIcon } from "./mui-DKIosbOx.js";
import { u as useNavigate, r as reactExports } from "./vendor-Cu2L4Rr-.js";
import { u as useAuth } from "./index-DPkTu3FI.js";
...
const MarketplacePage = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { backgroundColor: "background.default", minHeight: "100vh" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Container, { maxWidth: "xl", sx: { py: 4, pt: { xs: 12, md: 16 }, pb: 32 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { textAlign: "center", mb: 6, pt: { xs: 4, md: 6 } }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Typography,
          {
            variant: "h2",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { sx: { mb: 6, mt: 2, display: "flex", justifyContent: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Stack, { direction: "row", spacing: 1, sx: { flexWrap: "wrap", gap: 1, justifyContent: "center" }, children: categories.map((category) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Chip,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { sx: { display: "flex", justifyContent: "center", width: "100%", mt: 2 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Grid, { container: true, spacing: 4, justifyContent: "center", sx: { maxWidth: { xs: "100%", md: "800px", lg: "1000px" } }, children: filteredProducts.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsx(Grid, { item: true, xs: 12, sm: 6, md: 5, lg: 4, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductCard, { product }) }, product.id)) }) }),
