...
import { ch as utils, ci as interopRequireDefaultExports, j as jsxRuntimeExports, bD as useTheme, bE as useMediaQuery, aQ as DashboardIcon, cj as AdminPanelSettings, bj as Article, J as Support, aW as Settings, bS as LicenseIcon, K as CloudIcon, X as Group, a4 as PaymentIcon, ai as Receipt, as as Download, bF as AppBar, bG as Toolbar, B as Box, g as IconButton, A as ArrowBack, T as Typography, a as Button, ae as Avatar, bH as MenuIcon, ar as Menu, D as Divider, M as MenuItem, ck as ExitToApp, bK as Drawer, bm as Close, w as List, x as ListItem, y as ListItemIcon, z as ListItemText } from "./mui-DBh4ciAv.js";
import { a as getAugmentedNamespace, u as useNavigate, e as useLocation, r as reactExports } from "./vendor-Cu2L4Rr-.js";
import { u as useAuth } from "./index-DhGsANuG.js";
var ReceiptLong = {};
var createSvgIcon = {};
...
const Navigation = () => {
  ...
  const authenticatedNavItems = reactExports.useMemo(() => {
    ...
    return [
      ...
      { label: "Usage Analytics", path: "/dashboard/analytics", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, {}) },
      { label: "Downloads", path: "/dashboard/downloads", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Download, {}) },
      { label: "Documentation", path: "/documentation", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Article, {}) },
      { label: "Support", path: "/support", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Support, {}) },
      { label: "Settings", path: "/dashboard/settings", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, {}) }
    ];
    ...
    Drawer,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { p: 2, display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton, { onClick: handleDrawerToggle, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Close, {}) })
        ] }),
            ...
            ListItem,
            {
              ...
              children: [
                item.icon && /* @__PURE__ */ jsxRuntimeExports.jsx(ListItemIcon, { sx: {
                  color: item.label === "Admin" ? "warning.main" : item.label === "Licenses" ? "primary.main" : item.label === "Dashboard" ? "primary.main" : "text.primary"
                }, children: item.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ListItemText,
                  {
                    primary: item.label,
                    sx: {
                      color: item.label === "Admin" ? "warning.main" : item.label === "Licenses" ? "primary.main" : item.label === "Dashboard" ? "primary.main" : "inherit"
                    }
                  }
                )
              ]
      ...
      AppBar,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Toolbar, { sx: { justifyContent: "space-between" }, children: [
          ...
          !isMobile && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { sx: { display: "flex", alignItems: "center", gap: 2 }, children: isAuthenticated ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
