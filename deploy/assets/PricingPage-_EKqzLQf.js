...
const PricingPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { backgroundColor: "background.default", minHeight: "100vh" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { sx: { background: "linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%)", pt: { xs: 12, md: 16 }, pb: { xs: 6, md: 8 }, position: "relative" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Container, { maxWidth: "lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { sx: __spreadProps(__spreadValues({}, staggerAnimation), { "@keyframes fadeInUp": { "0%": { opacity: 0, transform: "translateY(60px)" }, "100%": { opacity: 1, transform: "translateY(0)" } }, "@keyframes staggerFadeIn": { "0%": { opacity: 0 }, "100%": { opacity: 1 } } }), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { textAlign: "center", sx: { mb: 6 }, children: [
