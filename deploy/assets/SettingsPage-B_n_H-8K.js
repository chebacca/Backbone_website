...
import { u as useAuth, c as api, e as endpoints, b as authService, d as apiUtils } from "./index-BRmJ_AYc.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { children: [
    ...
    activeTab === "compliance" && /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Paper,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "h6", sx: { fontWeight: 600, mb: 1 }, children: "Identity Verification" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { severity: "info", sx: { mb: 2 }, children: "Identity verification is now handled by Stripe during the payment process. No additional verification is required." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", color: "text.secondary", children: "Stripe will automatically collect and verify identity information when you make payments or set up billing. This ensures compliance with financial regulations while providing a seamless user experience." })
        ]
      }
    ) }),
