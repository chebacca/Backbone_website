const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CloudProjectIntegration-Cc86qYXG.js","assets/index-B_pg_yIa.js","assets/mui-CLBPY2Ik.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-B5XG1UK0.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
...
import { bF as useTheme, j as jsxRuntimeExports, b as Container, B as Box, T as Typography, G as Grid, t as Card, v as CardContent, w as List, x as ListItem, y as ListItemIcon, p as CheckCircleIcon, z as ListItemText, r as Chip, cf as CardActions, a as Button, at as Dialog, au as DialogTitle, av as DialogContent, a8 as FormControl, c3 as FormLabel, c4 as RadioGroup, F as FormControlLabel, c5 as Radio, aw as DialogActions, aM as ComputerIcon, c0 as NetworkIcon, bS as AddIcon, d as Alert, e as TextField, I as InputAdornment, b3 as SearchIcon, cg as SortIcon, R as RefreshIcon, aG as Tabs, aH as Tab, bE as Badge, aD as Skeleton, ar as Menu, M as MenuItem, ch as FolderOpenIcon, bW as FolderIcon, g as IconButton, aq as MoreVertIcon, a0 as PeopleIcon, a6 as StorageIcon, K as CloudIcon, C as CircularProgress, i as LinearProgress, ci as Fade } from "./mui-CLBPY2Ik.js";
import { r as reactExports, u as useNavigate } from "./vendor-Cu2L4Rr-.js";
import { s as simplifiedStartupSequencer, U as UnifiedProjectCreationDialog } from "./UnifiedProjectCreationDialog-B5Tp9qui.js";
import { _ as __vitePreload } from "./index-B_pg_yIa.js";
import LoginPage from "./LoginPage-D2e-V9Xj.js";
import "./CloudProjectIntegration-Cc86qYXG.js";
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-Cc86qYXG.js").then((n) => n.C);
