const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CloudProjectIntegration-tHlKAcZj.js","assets/index-BiKabvB6.js","assets/mui-DHh4JGm2.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-DrlueFI9.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
...
import { s as simplifiedStartupSequencer, U as UnifiedProjectCreationDialog } from "./UnifiedProjectCreationDialog-D3pF1T5x.js";
import { _ as __vitePreload } from "./index-BiKabvB6.js";
import LoginPage from "./LoginPage-DuKb-R0-.js";
import "./CloudProjectIntegration-tHlKAcZj.js";
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-tHlKAcZj.js").then((n) => n.C);
