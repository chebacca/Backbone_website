const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CloudProjectIntegration-DNbXShBe.js","assets/index-C4eF6KWV.js","assets/mui-kQ2X8N0A.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-TEyM19uV.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
...
import { s as simplifiedStartupSequencer, U as UnifiedProjectCreationDialog } from "./UnifiedProjectCreationDialog-BTqK-lOh.js";
import { _ as __vitePreload } from "./index-C4eF6KWV.js";
import LoginPage from "./LoginPage-B5Tv5bUS.js";
import "./CloudProjectIntegration-DNbXShBe.js";
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-DNbXShBe.js").then((n) => n.C);
