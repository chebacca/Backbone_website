const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CloudProjectIntegration-GH3ATHAi.js","assets/index-CGOaigZm.js","assets/mui-BoeRORKC.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-Luo-7hoF.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-GH3ATHAi.js").then((n) => n.C);
