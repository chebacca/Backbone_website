const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CloudProjectIntegration-DO_zVFdF.js","assets/index-CapzkfpX.js","assets/mui-BoeRORKC.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-Luo-7hoF.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
...
import { s as simplifiedStartupSequencer, U as UnifiedProjectCreationDialog } from "./UnifiedProjectCreationDialog-DaH5-90r.js";
import { _ as __vitePreload } from "./index-CapzkfpX.js";
import LoginPage from "./LoginPage-R02KmFR3.js";
import "./CloudProjectIntegration-DO_zVFdF.js";
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-DO_zVFdF.js").then((n) => n.C);
