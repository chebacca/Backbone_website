...
import { s as simplifiedStartupSequencer, U as UnifiedProjectCreationDialog } from "./UnifiedProjectCreationDialog-CCR6J0Kf.js";
import { _ as __vitePreload } from "./index-_czX3gCs.js";
import LoginPage from "./LoginPage-Beg7qSVZ.js";
import "./CloudProjectIntegration-Ceg3mHeu.js";
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-Ceg3mHeu.js").then((n) => n.C);
