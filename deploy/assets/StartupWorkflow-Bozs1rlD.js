...
import { s as simplifiedStartupSequencer, U as UnifiedProjectCreationDialog } from "./UnifiedProjectCreationDialog-DQpFz2Bh.js";
import { _ as __vitePreload } from "./index-BIhewz1i.js";
import LoginPage from "./LoginPage-B35Yk8s4.js";
import "./CloudProjectIntegration-BNDtdSjF.js";
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-BNDtdSjF.js").then((n) => n.C);
