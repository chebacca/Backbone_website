const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CloudProjectIntegration-mk_-eVQm.js","assets/index-BMgPxnVi.js","assets/mui-DBh4ciAv.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-iYh_bQi1.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
...
import { bD as useTheme, j as jsxRuntimeExports, b as Container, B as Box, T as Typography, G as Grid, t as Card, v as CardContent, w as List, x as ListItem, y as ListItemIcon, p as CheckCircleIcon, z as ListItemText, r as Chip, cd as CardActions, a as Button, at as Dialog, au as DialogTitle, av as DialogContent, a8 as FormControl, c1 as FormLabel, c2 as RadioGroup, F as FormControlLabel, c3 as Radio, aw as DialogActions, aM as ComputerIcon, b_ as NetworkIcon, bQ as AddIcon, d as Alert, e as TextField, I as InputAdornment, b3 as SearchIcon, ce as SortIcon, R as RefreshIcon, aG as Tabs, aH as Tab, bC as Badge, aD as Skeleton, ar as Menu, M as MenuItem, cf as FolderOpenIcon, bU as FolderIcon, g as IconButton, aq as MoreVertIcon, a0 as PeopleIcon, a6 as StorageIcon, K as CloudIcon, C as CircularProgress, i as LinearProgress, cg as Fade } from "./mui-DBh4ciAv.js";
import { r as reactExports, u as useNavigate } from "./vendor-Cu2L4Rr-.js";
import { s as simplifiedStartupSequencer, U as UnifiedProjectCreationDialog } from "./UnifiedProjectCreationDialog-CfVL6AZC.js";
import { _ as __vitePreload } from "./index-BMgPxnVi.js";
import LoginPage from "./LoginPage-CSSkY2Md.js";
import "./CloudProjectIntegration-mk_-eVQm.js";
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-mk_-eVQm.js").then((n) => n.C);
