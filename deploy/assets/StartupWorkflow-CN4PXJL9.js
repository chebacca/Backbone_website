const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CloudProjectIntegration-7ZYSQow_.js","assets/index-DyMiOceZ.js","assets/mui-DJqJu8cJ.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-BZOVZ1Et.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
...
import { u as useTheme, j as jsxRuntimeExports, b as Container, B as Box, T as Typography, G as Grid, t as Card, w as CardContent, x as List, y as ListItem, z as ListItemIcon, p as CheckCircleIcon, H as ListItemText, r as Chip, bR as CardActions, a as Button, a4 as Dialog, a5 as DialogTitle, a7 as DialogContent, aj as FormControl, c6 as FormLabel, c7 as RadioGroup, F as FormControlLabel, c8 as Radio, aD as DialogActions, aS as ComputerIcon, c3 as NetworkIcon, bM as AddIcon, d as Alert, e as TextField, I as InputAdornment, b9 as SearchIcon, cm as SortIcon, R as RefreshIcon, aN as Tabs, aO as Tab, bJ as Badge, aK as Skeleton, aC as Menu, M as MenuItem, cn as FolderOpenIcon, cc as FolderIcon, g as IconButton, aB as MoreVertIcon, ad as PeopleIcon, ah as StorageIcon, N as CloudIcon, C as CircularProgress, i as LinearProgress, co as Fade } from "./mui-DJqJu8cJ.js";
import { r as reactExports, u as useNavigate } from "./vendor-Cu2L4Rr-.js";
import { s as simplifiedStartupSequencer, U as UnifiedProjectCreationDialog } from "./UnifiedProjectCreationDialog-I6dUqgdR.js";
import { _ as __vitePreload } from "./index-DyMiOceZ.js";
import LoginPage from "./LoginPage-CMDfQ_Dj.js";
import "./CloudProjectIntegration-7ZYSQow_.js";
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-7ZYSQow_.js").then((n) => n.C);
