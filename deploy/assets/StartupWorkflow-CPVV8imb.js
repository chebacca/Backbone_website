const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CloudProjectIntegration-dyr8GV9j.js","assets/index-DR04_0G6.js","assets/mui-CLBPY2Ik.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-B5XG1UK0.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
...
import { s as simplifiedStartupSequencer, U as UnifiedProjectCreationDialog } from "./UnifiedProjectCreationDialog-XB30yWKh.js";
import { _ as __vitePreload } from "./index-DR04_0G6.js";
import LoginPage from "./LoginPage-DbIOegpi.js";
import "./CloudProjectIntegration-dyr8GV9j.js";
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-dyr8GV9j.js").then((n) => n.C);
