...
import { s as simplifiedStartupSequencer, U as UnifiedProjectCreationDialog } from "./UnifiedProjectCreationDialog-CktLy0S6.js";
import { _ as __vitePreload } from "./index-Dx2eHdQc.js";
import LoginPage from "./LoginPage-D52WxpoB.js";
import "./CloudProjectIntegration-CDazdXFY.js";
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-CDazdXFY.js").then((n) => n.C);
