const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CloudProjectIntegration-CovfPLyw.js","assets/index-LZJdIfY7.js","assets/mui-BbtiZaA3.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-rmDQXWB-.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
...
import { s as simplifiedStartupSequencer, U as UnifiedProjectCreationDialog } from "./UnifiedProjectCreationDialog-CtEGwpxx.js";
import { _ as __vitePreload } from "./index-LZJdIfY7.js";
import LoginPage from "./LoginPage-DUkRAcQX.js";
import "./CloudProjectIntegration-CovfPLyw.js";
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-CovfPLyw.js").then((n) => n.C);
