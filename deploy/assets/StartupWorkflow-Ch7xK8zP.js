const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CloudProjectIntegration-LRVaRH9P.js","assets/index-DB7RolcD.js","assets/mui-DJqJu8cJ.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-BZOVZ1Et.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
...
import { s as simplifiedStartupSequencer, U as UnifiedProjectCreationDialog } from "./UnifiedProjectCreationDialog-BMaVtisL.js";
import { _ as __vitePreload } from "./index-DB7RolcD.js";
import LoginPage from "./LoginPage-CM75Q-2N.js";
import "./CloudProjectIntegration-LRVaRH9P.js";
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-LRVaRH9P.js").then((n) => n.C);
