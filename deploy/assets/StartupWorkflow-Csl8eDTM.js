const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CloudProjectIntegration-BHycdzyA.js","assets/index-D9ISUMgg.js","assets/mui-Cc0LuBKd.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-CSTr_BWb.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
...
import { u as useTheme, j as jsxRuntimeExports, b as Container, B as Box, T as Typography, G as Grid, t as Card, w as CardContent, x as List, y as ListItem, z as ListItemIcon, p as CheckCircleIcon, H as ListItemText, r as Chip, cf as CardActions, a as Button, au as Dialog, av as DialogTitle, aw as DialogContent, a9 as FormControl, c3 as FormLabel, c4 as RadioGroup, F as FormControlLabel, c5 as Radio, ax as DialogActions, aN as ComputerIcon, c0 as NetworkIcon, bS as AddIcon, d as Alert, e as TextField, I as InputAdornment, b4 as SearchIcon, cg as SortIcon, R as RefreshIcon, aH as Tabs, aI as Tab, bF as Badge, aE as Skeleton, as as Menu, M as MenuItem, ch as FolderOpenIcon, bW as FolderIcon, g as IconButton, ar as MoreVertIcon, a1 as PeopleIcon, a7 as StorageIcon, N as CloudIcon, C as CircularProgress, i as LinearProgress, ci as Fade } from "./mui-Cc0LuBKd.js";
import { r as reactExports, u as useNavigate } from "./vendor-Cu2L4Rr-.js";
import { s as simplifiedStartupSequencer, U as UnifiedProjectCreationDialog } from "./UnifiedProjectCreationDialog-DM3L0D4x.js";
import { _ as __vitePreload } from "./index-D9ISUMgg.js";
import LoginPage from "./LoginPage-BY3BR6iz.js";
import "./CloudProjectIntegration-BHycdzyA.js";
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-BHycdzyA.js").then((n) => n.C);
