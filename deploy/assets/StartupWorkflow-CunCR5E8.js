const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CloudProjectIntegration-BypaGFDv.js","assets/index-BXT1li7d.js","assets/mui-DHh4JGm2.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-DrlueFI9.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
...
import { u as useTheme, j as jsxRuntimeExports, b as Container, B as Box, T as Typography, G as Grid, t as Card, w as CardContent, x as List, y as ListItem, z as ListItemIcon, p as CheckCircleIcon, H as ListItemText, r as Chip, bS as CardActions, a as Button, a4 as Dialog, a5 as DialogTitle, a7 as DialogContent, aj as FormControl, c7 as FormLabel, c8 as RadioGroup, F as FormControlLabel, c9 as Radio, aD as DialogActions, aS as ComputerIcon, c4 as NetworkIcon, bM as AddIcon, d as Alert, e as TextField, I as InputAdornment, b9 as SearchIcon, cn as SortIcon, R as RefreshIcon, aN as Tabs, aO as Tab, bJ as Badge, aK as Skeleton, aC as Menu, M as MenuItem, co as FolderOpenIcon, cd as FolderIcon, g as IconButton, aB as MoreVertIcon, ad as PeopleIcon, ah as StorageIcon, N as CloudIcon, C as CircularProgress, i as LinearProgress, cp as Fade } from "./mui-DHh4JGm2.js";
import { r as reactExports, u as useNavigate } from "./vendor-Cu2L4Rr-.js";
import { s as simplifiedStartupSequencer, U as UnifiedProjectCreationDialog } from "./UnifiedProjectCreationDialog-VWHWwxzh.js";
import { _ as __vitePreload } from "./index-BXT1li7d.js";
import LoginPage from "./LoginPage-U495VmVo.js";
import "./CloudProjectIntegration-BypaGFDv.js";
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-BypaGFDv.js").then((n) => n.C);
