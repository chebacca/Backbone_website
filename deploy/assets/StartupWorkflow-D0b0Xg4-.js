const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CloudProjectIntegration-DJPudBAA.js","assets/index-CDEjieLs.js","assets/mui-DKIosbOx.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-CqWXfGEZ.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
...
import { s as simplifiedStartupSequencer, U as UnifiedProjectCreationDialog } from "./UnifiedProjectCreationDialog-CCbJc8Ap.js";
import { _ as __vitePreload } from "./index-CDEjieLs.js";
import LoginPage from "./LoginPage-BXFSzJwR.js";
import "./CloudProjectIntegration-DJPudBAA.js";
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-DJPudBAA.js").then((n) => n.C);
