const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CloudProjectIntegration-DvP2BXC4.js","assets/index-CwCxFwse.js","assets/mui-DHh4JGm2.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-DrlueFI9.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
...
import { s as simplifiedStartupSequencer, U as UnifiedProjectCreationDialog } from "./UnifiedProjectCreationDialog-Cy0PGUW1.js";
import { _ as __vitePreload } from "./index-CwCxFwse.js";
import LoginPage from "./LoginPage--l-TKS2X.js";
import "./CloudProjectIntegration-DvP2BXC4.js";
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-DvP2BXC4.js").then((n) => n.C);
