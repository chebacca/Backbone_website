...
import { s as simplifiedStartupSequencer, U as UnifiedProjectCreationDialog } from "./UnifiedProjectCreationDialog-3OVgK24d.js";
import { _ as __vitePreload } from "./index-hqPZGME3.js";
import LoginPage from "./LoginPage-DNu9HNBO.js";
import "./CloudProjectIntegration-BRS3HTto.js";
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-BRS3HTto.js").then((n) => n.C);
