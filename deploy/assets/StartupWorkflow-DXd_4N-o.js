const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CloudProjectIntegration-DnAzTyzV.js","assets/index-DHDSU-2u.js","assets/mui-kQ2X8N0A.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-TEyM19uV.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
...
import { u as useTheme, j as jsxRuntimeExports, b as Container, B as Box, T as Typography, G as Grid, t as Card, w as CardContent, x as List, y as ListItem, z as ListItemIcon, p as CheckCircleIcon, H as ListItemText, r as Chip, bQ as CardActions, a as Button, a4 as Dialog, a5 as DialogTitle, a7 as DialogContent, aj as FormControl, c6 as FormLabel, c7 as RadioGroup, F as FormControlLabel, c8 as Radio, aD as DialogActions, aM as ComputerIcon, c3 as NetworkIcon, bL as AddIcon, d as Alert, e as TextField, I as InputAdornment, b8 as SearchIcon, cn as SortIcon, R as RefreshIcon, aU as Tabs, aV as Tab, bI as Badge, aK as Skeleton, aC as Menu, M as MenuItem, co as FolderOpenIcon, cc as FolderIcon, g as IconButton, aB as MoreVertIcon, ad as PeopleIcon, ah as StorageIcon, N as CloudIcon, C as CircularProgress, i as LinearProgress, cp as Fade } from "./mui-kQ2X8N0A.js";
import { r as reactExports, u as useNavigate } from "./vendor-Cu2L4Rr-.js";
import { s as simplifiedStartupSequencer, U as UnifiedProjectCreationDialog } from "./UnifiedProjectCreationDialog-BlITl67x.js";
import { _ as __vitePreload } from "./index-DHDSU-2u.js";
import LoginPage from "./LoginPage-C0cjnuaW.js";
import "./CloudProjectIntegration-DnAzTyzV.js";
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-DnAzTyzV.js").then((n) => n.C);
