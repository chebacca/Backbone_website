const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CloudProjectIntegration-CvYNW4gW.js","assets/index-BQLJIeWl.js","assets/mui-DKIosbOx.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-CqWXfGEZ.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
...
import { u as useTheme, j as jsxRuntimeExports, b as Container, B as Box, T as Typography, G as Grid, t as Card, w as CardContent, x as List, y as ListItem, z as ListItemIcon, p as CheckCircleIcon, H as ListItemText, r as Chip, bP as CardActions, a as Button, a4 as Dialog, a5 as DialogTitle, a7 as DialogContent, aj as FormControl, c5 as FormLabel, c6 as RadioGroup, F as FormControlLabel, c7 as Radio, aD as DialogActions, aM as ComputerIcon, c2 as NetworkIcon, bK as AddIcon, d as Alert, e as TextField, I as InputAdornment, b5 as SearchIcon, cm as SortIcon, R as RefreshIcon, aQ as Tabs, aR as Tab, bH as Badge, aK as Skeleton, aC as Menu, M as MenuItem, cn as FolderOpenIcon, cb as FolderIcon, g as IconButton, aB as MoreVertIcon, ad as PeopleIcon, ah as StorageIcon, N as CloudIcon, C as CircularProgress, i as LinearProgress, co as Fade } from "./mui-DKIosbOx.js";
import { r as reactExports, u as useNavigate } from "./vendor-Cu2L4Rr-.js";
import { s as simplifiedStartupSequencer, U as UnifiedProjectCreationDialog } from "./UnifiedProjectCreationDialog-BESXCAGz.js";
import { _ as __vitePreload } from "./index-BQLJIeWl.js";
import LoginPage from "./LoginPage-uNqzKqvc.js";
import "./CloudProjectIntegration-CvYNW4gW.js";
      ...
      if (mode === "shared_network" || storageMode === "cloud" || storageMode === "hybrid") {
        try {
          const { cloudProjectIntegration } = yield __vitePreload(() => __async(void 0, null, function* () {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield import("./CloudProjectIntegration-CvYNW4gW.js").then((n) => n.C);
