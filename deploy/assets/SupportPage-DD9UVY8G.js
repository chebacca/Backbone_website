import { j as jsxRuntimeExports, B as Box, T as Typography, G as Grid, t as Card, w as CardContent, a as Button, c as Paper, aU as Tabs, aV as Tab, an as Analytics, a3 as Download, bm as Description, Q as Accordion, U as AccordionSummary, W as ExpandMoreIcon, X as AccordionDetails, r as Chip, au as TrendingUp, bn as BarChart, af as Assessment, bo as GetApp, ag as Code, bp as Article, aZ as School, b3 as PlayArrow, Y as Group, b5 as Message, x as List, y as ListItem, z as ListItemIcon, E as EmailIcon, H as ListItemText, bq as Phone, a9 as Schedule, b1 as Work, br as VideoCall, a4 as Dialog, a5 as DialogTitle, ap as Avatar, K as Support, g as IconButton, a6 as CloseIcon, a7 as DialogContent, aD as DialogActions, bs as Chat } from "./mui-kQ2X8N0A.js";
...
const SupportPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { minHeight: "100vh", backgroundColor: "background.default" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { sx: {
      ...
      background: (theme) => theme.palette.mode === "dark" ? "linear-gradient(135deg, #0f0f23 0%, #1a1a2e 50%, #16213e 100%)" : "linear-gradient(135deg, #f8f9fa 0%, #e9ecef 50%, #dee2e6 100%)",
      borderRadius: 2,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { mb: 4 }, children: [
        ...
        }, children: "Get help with your BackboneLogic, Inc. platform" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Grid, { container: true, spacing: { xs: 2, sm: 3, md: 4 }, sx: { mb: { xs: 3, sm: 4, md: 5 } }, children: supportChannels.map((channel, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Grid, { item: true, xs: 12, sm: 6, lg: 3, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          sx: {
            height: "100%",
            background: (theme) => theme.palette.mode === "dark" ? "linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,255,255,0.05) 100%)" : "linear-gradient(135deg, rgba(0,0,0,0.05) 0%, rgba(0,0,0,0.02) 100%)",
            backdropFilter: "blur(20px)",
            border: (theme) => theme.palette.mode === "dark" ? "1px solid rgba(255,255,255,0.1)" : "1px solid rgba(0,0,0,0.1)",
            transition: "all 0.3s ease",
            "&:hover": {
              transform: "translateY(-4px)",
              boxShadow: (theme) => theme.palette.mode === "dark" ? "0 12px 24px rgba(0, 212, 255, 0.2)" : "0 12px 24px rgba(0, 212, 255, 0.15)"
            }
          },
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(List, { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(ListItem, { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(ListItemIcon, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(EmailIcon, { color: "primary" }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            ListItemText,
                            {
                              primary: "Email",
        ...
        Dialog,
        {
          ...
          PaperProps: {
            sx: {
              ...
              border: (theme) => theme.palette.mode === "dark" ? "1px solid rgba(0, 212, 255, 0.2)" : "1px solid rgba(0, 212, 255, 0.3)"
            }
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { sx: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton, { onClick: () => setChatDialogOpen(false), children: /* @__PURE__ */ jsxRuntimeExports.jsx(CloseIcon, {}) })
            ] }),
