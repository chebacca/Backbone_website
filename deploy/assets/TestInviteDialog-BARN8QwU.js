...
import { j as jsxRuntimeExports, au as Dialog, av as DialogTitle, B as Box, bE as PersonAddIcon, T as Typography, g as IconButton, bn as CloseIcon, aw as DialogContent, G as Grid, e as TextField, I as InputAdornment, E as EmailIcon, a9 as FormControl, aa as InputLabel, ab as Select, M as MenuItem, V as VisibilityOff, h as Visibility, a as Button, ax as DialogActions, C as CircularProgress } from "./mui-Cc0LuBKd.js";
  ...
  const handleSubmit = () => __async(void 0, null, function* () {
    ...
    try {
      const { auth, db } = yield __vitePreload(() => __async(void 0, null, function* () {
        const { auth: auth2, db: db2 } = yield import("./firebase-ChUl8N21.js").then((n) => n.f);
