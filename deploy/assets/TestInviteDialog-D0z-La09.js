...
import { j as jsxRuntimeExports, at as Dialog, au as DialogTitle, B as Box, bD as PersonAddIcon, T as Typography, g as IconButton, bm as CloseIcon, av as DialogContent, G as Grid, e as TextField, I as InputAdornment, E as EmailIcon, a8 as FormControl, a9 as InputLabel, aa as Select, M as MenuItem, V as VisibilityOff, h as Visibility, a as Button, aw as DialogActions, C as CircularProgress } from "./mui-CLBPY2Ik.js";
  ...
  const handleSubmit = () => __async(void 0, null, function* () {
    ...
    try {
      const { auth, db } = yield __vitePreload(() => __async(void 0, null, function* () {
        const { auth: auth2, db: db2 } = yield import("./firebase-BqNFDLEH.js").then((n) => n.f);
