...
import { COLLECTIONS, firestoreCollectionManager } from "./FirestoreCollectionManager-BY0dozSv.js";
    ...
    return __async(this, null, function* () {
      try {
        ...
        const { db, auth } = yield __vitePreload(() => __async(this, null, function* () {
          const { db: db2, auth: auth2 } = yield import("./firebase-aDUAJNZf.js").then((n) => n.f);
