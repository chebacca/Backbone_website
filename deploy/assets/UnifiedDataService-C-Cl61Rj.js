const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/firebase-DWXhlE7v.js","assets/index-D0VWCs-W.js","assets/mui-DKIosbOx.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-CqWXfGEZ.js","assets/index-COak77tQ.css","assets/index.esm-zVCMB3Cx.js","assets/index.esm-CjtNHFZy.js","assets/index.esm-D5-7iBdy.js"])))=>i.map(i=>d[i]);
...
import { COLLECTIONS, firestoreCollectionManager } from "./FirestoreCollectionManager-bebRMbgr.js";
import "./mui-DKIosbOx.js";
...
const _UnifiedDataService = class _UnifiedDataService {
    ...
    return __async(this, null, function* () {
      try {
        ...
        const { db, auth } = yield __vitePreload(() => __async(this, null, function* () {
          const { db: db2, auth: auth2 } = yield import("./firebase-DWXhlE7v.js").then((n) => n.f);
      ...
      try {
        ...
        if (currentUserEmail === "standalone.user@example.com") {
          ...
          const standaloneUser = {
            ...
            organization: {
              id: "standalone-org",
              // Use the standalone organization
            ...
            license: {
              ...
              // Standalone users don't create projects
              canManageTeam: false
              // Standalone users don't manage teams
            },
            status: "ACTIVE",
            createdAt: /* @__PURE__ */ new Date(),
            updatedAt: /* @__PURE__ */ new Date()
    ...
    return __async(this, null, function* () {
      ...
      try {
        if (user.organization.id === "standalone-org") {
          ...
          this.setCache(cacheKey, context2, 10 * 60 * 1e3);
          return context2;
        }
  ...
  getStandaloneLicenses() {
    return __async(this, null, function* () {
      ...
      try {
        const response = yield fetch("/api/standalone/licenses", {
          method: "GET",
          headers: {
        ...
        if (!response.ok) {
          throw new Error(`Failed to fetch standalone licenses: ${response.statusText}`);
        }
        const result = yield response.json();
        if (!result.success) {
          throw new Error(result.error || "Failed to fetch standalone licenses");
        }
        const standaloneUser = result.data.user;
        const licensesData = result.data.licenses;
        const licenses = [];
        if (licensesData.callsheetPro) {
          const license = licensesData.callsheetPro;
          licenses.push({
            id: license.id,
            key: license.key,
            name: "Call Sheet Pro",
            ...
            assignedTo: {
              ...
              name: user.name,
              email: user.email,
              assignedAt: license.assignedAt || license.activatedAt || /* @__PURE__ */ new Date()
            },
            usage: {
              apiCalls: license.usageCount || 0,
              dataTransfer: 0,
              deviceCount: 1,
              maxDevices: ((_a = license.limits) == null ? void 0 : _a.maxDevices) || 5
            },
        ...
        if (licensesData.edlConverterPro) {
          const license = licensesData.edlConverterPro;
          licenses.push({
            id: license.id,
            key: license.key,
            ...
            usage: {
              ...
              dataTransfer: 0,
              deviceCount: 1,
              maxDevices: ((_b = license.limits) == null ? void 0 : _b.maxDevices) || 5
            },
            activatedAt: license.activatedAt,
            expiresAt: license.expiresAt,
            lastUsed: license.lastUsed,
