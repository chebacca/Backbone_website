...
import { COLLECTIONS, firestoreCollectionManager } from "./FirestoreCollectionManager-tU0T92ly.js";
    ...
    return __async(this, null, function* () {
      try {
        ...
        const { db, auth } = yield __vitePreload(() => __async(this, null, function* () {
          const { db: db2, auth: auth2 } = yield import("./firebase-3dHLDtU-.js").then((n) => n.f);
