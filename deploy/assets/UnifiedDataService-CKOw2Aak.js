...
import { COLLECTIONS, firestoreCollectionManager } from "./FirestoreCollectionManager-wFb98Hr5.js";
    ...
    return __async(this, null, function* () {
      try {
        ...
        const { db, auth } = yield __vitePreload(() => __async(this, null, function* () {
          const { db: db2, auth: auth2 } = yield import("./firebase-BPHPk3OZ.js").then((n) => n.f);
