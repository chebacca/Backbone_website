...
import { COLLECTIONS, firestoreCollectionManager } from "./FirestoreCollectionManager-BcozZ9zd.js";
    ...
    return __async(this, null, function* () {
      try {
        ...
        const { db, auth } = yield __vitePreload(() => __async(this, null, function* () {
          const { db: db2, auth: auth2 } = yield import("./firebase-DMkueeOY.js").then((n) => n.f);
