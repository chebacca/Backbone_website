const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/firebase-CxbSQ7r3.js","assets/index-C4eF6KWV.js","assets/mui-kQ2X8N0A.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-TEyM19uV.js","assets/index-COak77tQ.css","assets/index.esm-6tSZEpI2.js","assets/index.esm-CORWL332.js","assets/index.esm-Bwx4LHm0.js"])))=>i.map(i=>d[i]);
...
import { getDoc, doc, query, collection, where, getDocs, updateDoc, addDoc, setDoc, arrayUnion, arrayRemove, limit, orderBy, writeBatch } from "./index.esm-CORWL332.js";
import { COLLECTIONS, firestoreCollectionManager } from "./FirestoreCollectionManager-C0cVebWr.js";
import "./mui-kQ2X8N0A.js";
        ...
        const licenses = snapshot.docs.map((doc2) => {
          ...
          return {
            ...
            assignedTo: {
              ...
              name: user.name,
              email: user.email,
              assignedAt: ((_a = data.assignedAt) == null ? void 0 : _a.toDate()) || ((_b = data.activatedAt) == null ? void 0 : _b.toDate()) || /* @__PURE__ */ new Date()
            },
            usage: {
              apiCalls: data.usageCount || 0,
              dataTransfer: 0,
              deviceCount: 1,
              maxDevices: ((_c = data.limits) == null ? void 0 : _c.maxDevices) || 5
            },
            activatedAt: (_d = data.activatedAt) == null ? void 0 : _d.toDate(),
            expiresAt: ((_e = data.expiresAt) == null ? void 0 : _e.toDate()) || /* @__PURE__ */ new Date(),
            lastUsed: (_f = data.lastUsed) == null ? void 0 : _f.toDate(),
