...
import { COLLECTIONS, firestoreCollectionManager } from "./FirestoreCollectionManager-D3JS9wCr.js";
import "./mui-DBh4ciAv.js";
  ...
  removeTeamMember(memberId, organizationId) {
    return __async(this, null, function* () {
      try {
        ...
        const response = yield fetch(`${window.location.origin}/api/team-members/remove-completely`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${token}`
