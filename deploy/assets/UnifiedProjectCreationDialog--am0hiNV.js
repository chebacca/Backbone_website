...
import { c as cloudProjectIntegration } from "./CloudProjectIntegration-Cm26huZ6.js";
        ...
        if (mode === "shared_network") {
          try {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield __vitePreload(() => __async(this, null, function* () {
              const { cloudProjectIntegration: cloudProjectIntegration3 } = yield import("./CloudProjectIntegration-Cm26huZ6.js").then((n) => n.C);
