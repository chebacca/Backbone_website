...
import { c as cloudProjectIntegration } from "./CloudProjectIntegration-BVVGz7FU.js";
        ...
        if (mode === "shared_network") {
          try {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield __vitePreload(() => __async(this, null, function* () {
              const { cloudProjectIntegration: cloudProjectIntegration3 } = yield import("./CloudProjectIntegration-BVVGz7FU.js").then((n) => n.C);
