...
import { c as cloudProjectIntegration } from "./CloudProjectIntegration-DPc_ZlHu.js";
        ...
        if (mode === "shared_network") {
          try {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield __vitePreload(() => __async(this, null, function* () {
              const { cloudProjectIntegration: cloudProjectIntegration3 } = yield import("./CloudProjectIntegration-DPc_ZlHu.js").then((n) => n.C);
