const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CloudProjectIntegration-CDazdXFY.js","assets/index-Dx2eHdQc.js","assets/mui-gCwp_wLb.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-Dk1a53Oq.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
...
import { c as cloudProjectIntegration } from "./CloudProjectIntegration-CDazdXFY.js";
        ...
        if (mode === "shared_network") {
          try {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield __vitePreload(() => __async(this, null, function* () {
              const { cloudProjectIntegration: cloudProjectIntegration3 } = yield import("./CloudProjectIntegration-CDazdXFY.js").then((n) => n.C);
