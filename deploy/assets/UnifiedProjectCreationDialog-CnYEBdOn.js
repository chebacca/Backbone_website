...
import { c as cloudProjectIntegration } from "./CloudProjectIntegration-CX41k30L.js";
        ...
        if (mode === "shared_network") {
          try {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield __vitePreload(() => __async(this, null, function* () {
              const { cloudProjectIntegration: cloudProjectIntegration3 } = yield import("./CloudProjectIntegration-CX41k30L.js").then((n) => n.C);
