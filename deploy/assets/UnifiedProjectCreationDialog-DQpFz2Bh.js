const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CloudProjectIntegration-BNDtdSjF.js","assets/index-BIhewz1i.js","assets/mui-C-OPHTyf.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-DBN2V-e6.js","assets/index-COak77tQ.css"])))=>i.map(i=>d[i]);
        ...
        if (mode === "shared_network") {
          try {
            const { cloudProjectIntegration: cloudProjectIntegration2 } = yield __vitePreload(() => __async(this, null, function* () {
              const { cloudProjectIntegration: cloudProjectIntegration3 } = yield import("./CloudProjectIntegration-BNDtdSjF.js").then((n) => n.C);
