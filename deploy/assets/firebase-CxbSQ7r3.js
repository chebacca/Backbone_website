const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index.esm-Bwx4LHm0.js","assets/index.esm-6tSZEpI2.js","assets/FirestoreCollectionManager-C0cVebWr.js","assets/index-C4eF6KWV.js","assets/mui-kQ2X8N0A.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-TEyM19uV.js","assets/index-COak77tQ.css","assets/index.esm-CORWL332.js"])))=>i.map(i=>d[i]);
...
import { r as registerVersion, g as getApp, _ as _getProvider, a as getModularInstance, b as getDefaultEmulatorHostnameAndPort, i as isCloudWorkstation, p as pingServer, u as updateEmulatorBanner, F as FirebaseError, c as _registerComponent, C as Component, d as _isFirebaseServerApp, S as SDK_VERSION, e as createMockUserToken, f as initializeApp, h as getApps, D as DEFAULT_ENTRY_NAME, j as _addComponent, k as _apps, l as _components, m as _serverApps } from "./index.esm-6tSZEpI2.js";
import { getFirestore, query, collection, where, getDocs, getDoc, doc, orderBy, addDoc, deleteDoc, connectFirestoreEmulator } from "./index.esm-CORWL332.js";
import { getAuth, connectAuthEmulator } from "./index.esm-Bwx4LHm0.js";
var name$2 = "firebase";
...
if (auth) {
  __vitePreload(() => __async(void 0, null, function* () {
    const { setPersistence, browserLocalPersistence } = yield import("./index.esm-Bwx4LHm0.js");
...
const initializeFirebaseCollections = () => __async(void 0, null, function* () {
  ...
  try {
    const { firestoreCollectionManager } = yield __vitePreload(() => __async(void 0, null, function* () {
      const { firestoreCollectionManager: firestoreCollectionManager2 } = yield import("./FirestoreCollectionManager-C0cVebWr.js");
...
const loadUserFromFirestore = (firebaseUser) => __async(void 0, null, function* () {
  ...
  try {
    const { doc: doc2, getDoc: getDoc2, query: query2, collection: collection2, where: where2, getDocs: getDocs2 } = yield __vitePreload(() => __async(void 0, null, function* () {
      const { doc: doc22, getDoc: getDoc22, query: query22, collection: collection22, where: where22, getDocs: getDocs22 } = yield import("./index.esm-CORWL332.js");
