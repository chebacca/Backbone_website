const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/firebase-CxbSQ7r3.js","assets/index.esm-6tSZEpI2.js","assets/index.esm-CORWL332.js","assets/index.esm-Bwx4LHm0.js","assets/UnifiedDataService-CmxnkHtJ.js","assets/FirestoreCollectionManager-C0cVebWr.js","assets/mui-kQ2X8N0A.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-TEyM19uV.js","assets/LandingPage-CYgaFXjv.js","assets/Navigation-BHA5e-Ny.js","assets/ThemeToggle-Dfk-xxg9.js","assets/Footer-5eKVLoK4.js","assets/MarketplacePage-D-sH__Z_.js","assets/LoginPage-B5Tv5bUS.js","assets/index.esm-aV5ahHn5.js","assets/notistack.esm-DLh02w5s.js","assets/BridgeAuthPage-C7UogAFD.js","assets/RegisterPage-B0gZ0z_S.js","assets/ForgotPasswordPage-BJd188C5.js","assets/ResetPasswordPage-DJM5CkXO.js","assets/EmailVerificationPage-CheFJUzl.js","assets/PricingPage-NRJaadBm.js","assets/TermsPage-CIPCe0G8.js","assets/PrivacyPolicyPage-PyuBn0aG.js","assets/SlaPage-C0ank8SQ.js","assets/CookiePolicyPage-CuGaQ2B_.js","assets/CheckoutPage-DXcWtJOy.js","assets/StandaloneCheckoutPage-BN6RoNSJ.js","assets/DownloadPage-CHiB1NMU.js","assets/DashboardLayout-BzrEl4zZ.js","assets/DashboardOverview-D54M3z7K.js","assets/MetricCard-CBO42J1_.js","assets/useStreamlinedData-CqNnYqGA.js","assets/DashboardCloudProjectsBridge-HkiL5Qy_.js","assets/CloudProjectIntegration-DNbXShBe.js","assets/UnifiedProjectCreationDialog-BTqK-lOh.js","assets/LicensesPage-BGvaE0WM.js","assets/security-dashboard-DoGiYCW0.js","assets/AnalyticsPage-BWcHFaIu.js","assets/BillingPage-f8kKUrD9.js","assets/StreamlinedBillingPage-DtQJuXI3.js","assets/SettingsPage-B066sP05.js","assets/EnhancedTeamPage-Cnai_Iyb.js","assets/TestStreamlinedHooks-CwOgUnAP.js","assets/DownloadsPage-8Ysyfc84.js","assets/DocumentationPage-DtOTjwkF.js","assets/SupportPage-DD9UVY8G.js","assets/InviteAcceptPage-C3cpuLRd.js","assets/AdminDashboard-DyxqOBkN.js","assets/AccountingDashboard-C3jyWr82.js","assets/NotFoundPage-C-LO-7TA.js","assets/StartupWorkflow-9VfphrpM.js","assets/OfflineTestPage-CIRxwrwF.js","assets/TestInviteDialog-B4ksp1ag.js","assets/TestTeamMemberCreation-CKql4iSR.js","assets/TestTeamMemberCreationSimple-C1ogn1pr.js"])))=>i.map(i=>d[i]);
...
import { j as jsxRuntimeExports, cR as Backdrop, B as Box, C as CircularProgress, T as Typography, b as Container, c as Paper, cS as ErrorOutline, d as Alert, a as Button, R as RefreshIcon, bG as Home, a_ as BugReport, cT as createTheme, cU as ThemeProvider$1, cV as CssBaseline } from "./mui-kQ2X8N0A.js";
...
import { E as Elements } from "./stripe-TEyM19uV.js";
(function polyfill() {
  ...
  login(email, password) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        const response = yield fetch(`${apiBaseUrl}/auth/login`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json"
          },
        ...
        const customToken = result.firebaseCustomToken || ((_a = result.data) == null ? void 0 : _a.firebaseCustomToken) || ((_c = (_b = result.data) == null ? void 0 : _b.tokens) == null ? void 0 : _c.accessToken);
        if (!customToken) {
          throw new Error("No authentication token received");
        }
        const { auth } = yield __vitePreload(() => __async(this, null, function* () {
          const { auth: auth2 } = yield import("./firebase-CxbSQ7r3.js").then((n) => n.f);
          return { auth: auth2 };
        }), true ? __vite__mapDeps([0,1,2,3]) : void 0);
        const { signInWithCustomToken } = yield __vitePreload(() => __async(this, null, function* () {
          const { signInWithCustomToken: signInWithCustomToken2 } = yield import("./index.esm-Bwx4LHm0.js");
          return { signInWithCustomToken: signInWithCustomToken2 };
        }), true ? __vite__mapDeps([3,1]) : void 0);
        const userCredential = yield signInWithCustomToken(auth, customToken);
        const firebaseUser = userCredential.user;
        const userData = result.user || ((_d = result.data) == null ? void 0 : _d.user);
        return {
          user: userData,
...
function cleanupInvalidUserData() {
...
const AuthProvider = ({ children }) => {
      ...
      try {
        ...
        if (token && userStr) {
          ...
          if (!validateUserObject(userData)) {
            console.warn("⚠️ [Auth] Invalid stored user data - missing email property:", userData == null ? void 0 : userData.email);
          ...
          try {
            ...
            try {
              ...
              if (!validateUserObject(validatedUser)) {
                console.warn("⚠️ [Auth] Invalid validatedUser object - missing email property:", validatedUser == null ? void 0 : validatedUser.email);
                console.log("🔧 [Auth] Clearing invalid user data from localStorage");
                cleanupInvalidUserData();
                return;
              }
              const { tryRestoreFirebaseSession, isEmailAuthenticated } = yield __vitePreload(() => __async(void 0, null, function* () {
                const { tryRestoreFirebaseSession: tryRestoreFirebaseSession2, isEmailAuthenticated: isEmailAuthenticated2 } = yield import("./firebase-CxbSQ7r3.js").then((n) => n.f);
                ...
                if (tempCredentials) {
                  try {
                    ...
                    const { signInWithEmailAndPassword } = yield __vitePreload(() => __async(void 0, null, function* () {
                      const { signInWithEmailAndPassword: signInWithEmailAndPassword2 } = yield import("./index.esm-Bwx4LHm0.js");
          ...
          try {
            ...
            const { onAuthStateChanged } = yield __vitePreload(() => __async(void 0, null, function* () {
              const { onAuthStateChanged: onAuthStateChanged2 } = yield import("./index.esm-Bwx4LHm0.js");
              ...
              if (firebaseUser) {
                ...
                try {
                  const { loadUserFromFirestore } = yield __vitePreload(() => __async(void 0, null, function* () {
                    const { loadUserFromFirestore: loadUserFromFirestore2 } = yield import("./firebase-CxbSQ7r3.js").then((n) => n.f);
          ...
          if (firebaseUser) {
            ...
            try {
              const { unifiedDataService } = yield __vitePreload(() => __async(void 0, null, function* () {
                const { unifiedDataService: unifiedDataService2 } = yield import("./UnifiedDataService-CmxnkHtJ.js");
  ...
  const login = (email, password) => __async(void 0, null, function* () {
    ...
    try {
      ...
      if ((_a = response.user) == null ? void 0 : _a.firebaseUid) {
    ...
    (() => __async(void 0, null, function* () {
      try {
        ...
        const { signOut } = yield __vitePreload(() => __async(void 0, null, function* () {
          const { signOut: signOut2 } = yield import("./index.esm-Bwx4LHm0.js");
...
const createAppTheme = (mode) => {
  ...
  const themeOptions = {
    ...
    components: __spreadProps(__spreadValues({}, components), {
      ...
      MuiButton: __spreadProps(__spreadValues({}, components.MuiButton), {
        styleOverrides: __spreadProps(__spreadValues({}, (_a = components.MuiButton) == null ? void 0 : _a.styleOverrides), {
          root: __spreadValues(__spreadValues({}, (_c = (_b = components.MuiButton) == null ? void 0 : _b.styleOverrides) == null ? void 0 : _c.root), isDark ? {} : {
            "&.MuiButton-contained": {
      ...
      MuiAppBar: __spreadProps(__spreadValues({}, components.MuiAppBar), {
        styleOverrides: __spreadProps(__spreadValues({}, (_d = components.MuiAppBar) == null ? void 0 : _d.styleOverrides), {
          root: __spreadProps(__spreadValues({}, (_f = (_e = components.MuiAppBar) == null ? void 0 : _e.styleOverrides) == null ? void 0 : _f.root), {
      ...
      MuiPaper: __spreadProps(__spreadValues({}, components.MuiPaper), {
        styleOverrides: __spreadProps(__spreadValues({}, (_g = components.MuiPaper) == null ? void 0 : _g.styleOverrides), {
          root: __spreadProps(__spreadValues({}, (_i = (_h = components.MuiPaper) == null ? void 0 : _h.styleOverrides) == null ? void 0 : _i.root), {
            backgroundColor: isDark ? colors.darkBackground.paper : colors.lightBackground.paper,
            color: isDark ? colors.darkText.primary : colors.lightText.primary
          })
        })
      }),
      MuiCard: __spreadProps(__spreadValues({}, components.MuiCard), {
        styleOverrides: __spreadProps(__spreadValues({}, (_j = components.MuiCard) == null ? void 0 : _j.styleOverrides), {
          root: __spreadProps(__spreadValues({}, (_l = (_k = components.MuiCard) == null ? void 0 : _k.styleOverrides) == null ? void 0 : _l.root), {
            backgroundColor: isDark ? colors.darkBackground.paper : colors.lightBackground.paper,
            color: isDark ? colors.darkText.primary : colors.lightText.primary,
      ...
      MuiChip: __spreadProps(__spreadValues({}, components.MuiChip), {
        styleOverrides: __spreadProps(__spreadValues({}, (_m = components.MuiChip) == null ? void 0 : _m.styleOverrides), {
          root: __spreadProps(__spreadValues({}, (_o = (_n = components.MuiChip) == null ? void 0 : _n.styleOverrides) == null ? void 0 : _o.root), {
...
clearAuthWarnings();
const LandingPage = React.lazy(() => __vitePreload(() => import("./LandingPage-CYgaFXjv.js"), true ? __vite__mapDeps([9,6,7,10,11,12,8]) : void 0));
const MarketplacePage = React.lazy(() => __vitePreload(() => import("./MarketplacePage-D-sH__Z_.js"), true ? __vite__mapDeps([13,6,7,10,11,12,8]) : void 0));
const LoginPage = React.lazy(() => __vitePreload(() => import("./LoginPage-B5Tv5bUS.js"), true ? __vite__mapDeps([14,6,7,15,16,8]) : void 0));
const BridgeAuthPage = React.lazy(() => __vitePreload(() => import("./BridgeAuthPage-C7UogAFD.js"), true ? __vite__mapDeps([17,6,7]) : void 0));
const RegisterPage = React.lazy(() => __vitePreload(() => import("./RegisterPage-B0gZ0z_S.js"), true ? __vite__mapDeps([18,6,7,15,16,8]) : void 0));
const ForgotPasswordPage = React.lazy(() => __vitePreload(() => import("./ForgotPasswordPage-BJd188C5.js"), true ? __vite__mapDeps([19,6,7,15,16,8]) : void 0));
const ResetPasswordPage = React.lazy(() => __vitePreload(() => import("./ResetPasswordPage-DJM5CkXO.js"), true ? __vite__mapDeps([20,6,7,15,16,8]) : void 0));
const EmailVerificationPage = React.lazy(() => __vitePreload(() => import("./EmailVerificationPage-CheFJUzl.js"), true ? __vite__mapDeps([21,6,7,16,8]) : void 0));
const PricingPage = React.lazy(() => __vitePreload(() => import("./PricingPage-NRJaadBm.js"), true ? __vite__mapDeps([22,6,7,10,11,12,8]) : void 0));
const TermsPage = React.lazy(() => __vitePreload(() => import("./TermsPage-CIPCe0G8.js"), true ? __vite__mapDeps([23,6,7,10,11,12,8]) : void 0));
const PrivacyPolicyPage = React.lazy(() => __vitePreload(() => import("./PrivacyPolicyPage-PyuBn0aG.js"), true ? __vite__mapDeps([24,6,7,10,11,12,8]) : void 0));
const SlaPage = React.lazy(() => __vitePreload(() => import("./SlaPage-C0ank8SQ.js"), true ? __vite__mapDeps([25,6,7,10,11,12,8]) : void 0));
const CookiePolicyPage = React.lazy(() => __vitePreload(() => import("./CookiePolicyPage-CuGaQ2B_.js"), true ? __vite__mapDeps([26,6,7,10,11,12,8]) : void 0));
const CheckoutPage = React.lazy(() => __vitePreload(() => import("./CheckoutPage-DXcWtJOy.js"), true ? __vite__mapDeps([27,6,7,16,10,11,15,8]) : void 0));
const StandaloneCheckoutPage = React.lazy(() => __vitePreload(() => import("./StandaloneCheckoutPage-BN6RoNSJ.js"), true ? __vite__mapDeps([28,6,7,8]) : void 0));
const DownloadPage = React.lazy(() => __vitePreload(() => import("./DownloadPage-CHiB1NMU.js"), true ? __vite__mapDeps([29,6,7,8]) : void 0));
const DashboardLayout = React.lazy(() => __vitePreload(() => import("./DashboardLayout-BzrEl4zZ.js"), true ? __vite__mapDeps([30,6,7,11,8]) : void 0));
const DashboardOverview = React.lazy(() => __vitePreload(() => import("./DashboardOverview-D54M3z7K.js"), true ? __vite__mapDeps([31,6,7,0,1,2,3,32,33,4,5,8]) : void 0));
const DashboardCloudProjectsBridge = React.lazy(() => __vitePreload(() => import("./DashboardCloudProjectsBridge-HkiL5Qy_.js").then((n) => n.D), true ? __vite__mapDeps([34,6,7,2,1,0,3,35,36,4,5,8]) : void 0));
const LicensesPage = React.lazy(() => __vitePreload(() => import("./LicensesPage-BGvaE0WM.js"), true ? __vite__mapDeps([37,6,7,33,4,2,1,5,0,3,8,16]) : void 0));
const SecurityDashboardPage = React.lazy(() => __vitePreload(() => import("./security-dashboard-DoGiYCW0.js"), true ? __vite__mapDeps([38,6,7,3,1,8]) : void 0));
const AnalyticsPage = React.lazy(() => __vitePreload(() => import("./AnalyticsPage-BWcHFaIu.js"), true ? __vite__mapDeps([39,6,7,33,4,2,1,5,0,3,8,32]) : void 0));
React.lazy(() => __vitePreload(() => import("./BillingPage-f8kKUrD9.js"), true ? __vite__mapDeps([40,6,7,16,33,4,2,1,5,0,3,8,32]) : void 0));
const StreamlinedBillingPage = React.lazy(() => __vitePreload(() => import("./StreamlinedBillingPage-DtQJuXI3.js"), true ? __vite__mapDeps([41,6,7,16,33,4,2,1,5,0,3,8,32]) : void 0));
const SettingsPage = React.lazy(() => __vitePreload(() => import("./SettingsPage-B066sP05.js"), true ? __vite__mapDeps([42,6,7,16,8]) : void 0));
const TeamPage = React.lazy(() => __vitePreload(() => import("./EnhancedTeamPage-Cnai_Iyb.js"), true ? __vite__mapDeps([43,6,7,16,33,4,2,1,5,0,3,8,32]) : void 0));
const TestStreamlinedHooks = React.lazy(() => __vitePreload(() => import("./TestStreamlinedHooks-CwOgUnAP.js"), true ? __vite__mapDeps([44,6,7,33,4,2,1,5,0,3,8]) : void 0));
const DownloadsPage = React.lazy(() => __vitePreload(() => import("./DownloadsPage-8Ysyfc84.js"), true ? __vite__mapDeps([45,6,7,16,8]) : void 0));
const DocumentationPage = React.lazy(() => __vitePreload(() => import("./DocumentationPage-DtOTjwkF.js"), true ? __vite__mapDeps([46,6,7,16,10,11,12,8]) : void 0));
const SupportPage = React.lazy(() => __vitePreload(() => import("./SupportPage-DD9UVY8G.js"), true ? __vite__mapDeps([47,6,7,16,10,11,12,8]) : void 0));
const InviteAcceptPage = React.lazy(() => __vitePreload(() => import("./InviteAcceptPage-C3cpuLRd.js"), true ? __vite__mapDeps([48,6,7,16,8]) : void 0));
const AdminDashboard = React.lazy(() => __vitePreload(() => import("./AdminDashboard-DyxqOBkN.js"), true ? __vite__mapDeps([49,6,7,16,2,1,0,3,5,8]) : void 0));
const AccountingDashboard = React.lazy(() => __vitePreload(() => import("./AccountingDashboard-C3jyWr82.js"), true ? __vite__mapDeps([50,6,7,8]) : void 0));
const NotFoundPage = React.lazy(() => __vitePreload(() => import("./NotFoundPage-C-LO-7TA.js"), true ? __vite__mapDeps([51,6,7]) : void 0));
const StartupWorkflow = React.lazy(() => __vitePreload(() => import("./StartupWorkflow-9VfphrpM.js"), true ? __vite__mapDeps([52,6,7,36,35,14,15,16,8]) : void 0));
const OfflineTestPage = React.lazy(() => __vitePreload(() => import("./OfflineTestPage-CIRxwrwF.js"), true ? __vite__mapDeps([53,6,7,35,8]) : void 0));
const TestInviteDialog = React.lazy(() => __vitePreload(() => import("./TestInviteDialog-B4ksp1ag.js"), true ? __vite__mapDeps([54,6,7,16,8]) : void 0));
const TestTeamMemberCreation = React.lazy(() => __vitePreload(() => import("./TestTeamMemberCreation-CKql4iSR.js"), true ? __vite__mapDeps([55,6,7,16,33,4,2,1,5,0,3,8]) : void 0));
const TestTeamMemberCreationSimple = React.lazy(() => __vitePreload(() => import("./TestTeamMemberCreationSimple-C1ogn1pr.js"), true ? __vite__mapDeps([56,6,7,16,8]) : void 0));
...
const AppContent = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ThemeProvider$1, { theme, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { sx: { minHeight: "100vh", backgroundColor: "background.default", color: "text.primary" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/", element: /* @__PURE__ */ jsxRuntimeExports.jsx(PublicRoute, { allowAuthenticated: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LandingPage, {}) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/marketplace", element: /* @__PURE__ */ jsxRuntimeExports.jsx(PublicRoute, { allowAuthenticated: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(MarketplacePage, {}) }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Route,
        {
          ...
          element: /* @__PURE__ */ jsxRuntimeExports.jsx(ProtectedRoute, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(StandaloneCheckoutPage, {}) })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Route,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Route,
        {
          ...
          element: /* @__PURE__ */ jsxRuntimeExports.jsx(DownloadPage, {})
        }
      ),
...
const suppressChromeExtensionErrors = () => {
  ...
  console.error = (...args) => {
    ...
    if (message.includes("FrameDoesNotExistError") || message.includes("The message port closed before a response was received") || message.includes("Could not establish connection. Receiving end does not exist") || message.includes("extensionState.js") || message.includes("heuristicsRedefinitions.js") || message.includes("utils.js") || message.includes("classifier.js") || message.includes("injectLeap.js") || message.includes("bootstrap") || message.includes("Failed to load resource: net::ERR_FILE_NOT_FOUND")) {
      return;
    }
  ...
  console.warn = (...args) => {
    var _a;
    const message = ((_a = args[0]) == null ? void 0 : _a.toString()) || "";
    if (message.includes("[Report Only] Refused to compile or instantiate WebAssembly module") || message.includes("unsafe-eval is not an allowed source") || message.includes("script-src 'self'")) {
      return;
    }
