const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/firebase-CFcFFe5O.js","assets/index.esm-zVCMB3Cx.js","assets/index.esm-CjtNHFZy.js","assets/index.esm-D5-7iBdy.js","assets/UnifiedDataService-DqdH6pIz.js","assets/FirestoreCollectionManager-Dcit9t0j.js","assets/mui-kQ2X8N0A.js","assets/vendor-Cu2L4Rr-.js","assets/stripe-TEyM19uV.js","assets/LandingPage-Brw0Y6ot.js","assets/Navigation-BVAf23Hz.js","assets/ThemeToggle-BRRQBxzQ.js","assets/Footer-5eKVLoK4.js","assets/MarketplacePage-_j9IgiRC.js","assets/LoginPage-C0cjnuaW.js","assets/index.esm-aV5ahHn5.js","assets/notistack.esm-DLh02w5s.js","assets/BridgeAuthPage-C7UogAFD.js","assets/RegisterPage-FmJV4uxX.js","assets/ForgotPasswordPage-7v7YRR-y.js","assets/ResetPasswordPage-BiqQMUsx.js","assets/EmailVerificationPage-DI63Gr3V.js","assets/PricingPage-pe2W3jb4.js","assets/TermsPage-MPD-jcJU.js","assets/PrivacyPolicyPage-M6BdXBK3.js","assets/SlaPage-8aCKLkFJ.js","assets/CookiePolicyPage-Bt5QWQFA.js","assets/CheckoutPage-Bufg-Is3.js","assets/StandaloneCheckoutPage-C_9uYmzC.js","assets/DownloadPage-C2qC9z1n.js","assets/DashboardLayout-CM9-VymM.js","assets/DashboardOverview-xbndMz35.js","assets/MetricCard-CBO42J1_.js","assets/useStreamlinedData-DTS64T_w.js","assets/DashboardCloudProjectsBridge-BG2zaKl4.js","assets/CloudProjectIntegration-DnAzTyzV.js","assets/UnifiedProjectCreationDialog-BlITl67x.js","assets/LicensesPage-BUeG1qEo.js","assets/security-dashboard-DXfZzPUl.js","assets/AnalyticsPage-1wRjKUH4.js","assets/BillingPage-CIl8M4Vc.js","assets/StreamlinedBillingPage-CKLF3Dw5.js","assets/SettingsPage-mktdhs3M.js","assets/EnhancedTeamPage-Nd4gf2gh.js","assets/TestStreamlinedHooks-TeIMdvJZ.js","assets/DownloadsPage-Ou0W2x8Y.js","assets/DocumentationPage-ClCqGW2k.js","assets/SupportPage-DnxkJecC.js","assets/InviteAcceptPage-Cc9nhYsh.js","assets/AdminDashboard-IVS7j0qx.js","assets/AccountingDashboard-CLJ7EhA_.js","assets/NotFoundPage-C-LO-7TA.js","assets/StartupWorkflow-DXd_4N-o.js","assets/OfflineTestPage-CFPUO6j5.js","assets/TestInviteDialog-w5n5AfOQ.js","assets/TestTeamMemberCreation-Bbhi4nBh.js","assets/TestTeamMemberCreationSimple-oRNTUloW.js"])))=>i.map(i=>d[i]);
    ...
    return __async(this, null, function* () {
      try {
        const { auth } = yield __vitePreload(() => __async(this, null, function* () {
          const { auth: auth2 } = yield import("./firebase-CFcFFe5O.js").then((n) => n.f);
          return { auth: auth2 };
        }), true ? __vite__mapDeps([0,1,2,3]) : void 0);
        const { signInWithEmailAndPassword } = yield __vitePreload(() => __async(this, null, function* () {
          const { signInWithEmailAndPassword: signInWithEmailAndPassword2 } = yield import("./index.esm-D5-7iBdy.js");
        ...
        const { loadUserFromFirestore } = yield __vitePreload(() => __async(this, null, function* () {
          const { loadUserFromFirestore: loadUserFromFirestore2 } = yield import("./firebase-CFcFFe5O.js").then((n) => n.f);
          ...
          try {
            ...
            try {
              ...
              const { tryRestoreFirebaseSession, isEmailAuthenticated } = yield __vitePreload(() => __async(void 0, null, function* () {
                const { tryRestoreFirebaseSession: tryRestoreFirebaseSession2, isEmailAuthenticated: isEmailAuthenticated2 } = yield import("./firebase-CFcFFe5O.js").then((n) => n.f);
          ...
          if (firebaseUser) {
            ...
            try {
              const { unifiedDataService } = yield __vitePreload(() => __async(void 0, null, function* () {
                const { unifiedDataService: unifiedDataService2 } = yield import("./UnifiedDataService-DqdH6pIz.js");
    ...
    (() => __async(void 0, null, function* () {
      try {
        ...
        const { signOut } = yield __vitePreload(() => __async(void 0, null, function* () {
          const { signOut: signOut2 } = yield import("./index.esm-D5-7iBdy.js");
...
clearAuthWarnings();
const LandingPage = React.lazy(() => __vitePreload(() => import("./LandingPage-Brw0Y6ot.js"), true ? __vite__mapDeps([9,6,7,10,11,12,8]) : void 0));
const MarketplacePage = React.lazy(() => __vitePreload(() => import("./MarketplacePage-_j9IgiRC.js"), true ? __vite__mapDeps([13,6,7,10,11,12,8]) : void 0));
const LoginPage = React.lazy(() => __vitePreload(() => import("./LoginPage-C0cjnuaW.js"), true ? __vite__mapDeps([14,6,7,15,16,8]) : void 0));
const BridgeAuthPage = React.lazy(() => __vitePreload(() => import("./BridgeAuthPage-C7UogAFD.js"), true ? __vite__mapDeps([17,6,7]) : void 0));
const RegisterPage = React.lazy(() => __vitePreload(() => import("./RegisterPage-FmJV4uxX.js"), true ? __vite__mapDeps([18,6,7,15,16,8]) : void 0));
const ForgotPasswordPage = React.lazy(() => __vitePreload(() => import("./ForgotPasswordPage-7v7YRR-y.js"), true ? __vite__mapDeps([19,6,7,15,16,8]) : void 0));
const ResetPasswordPage = React.lazy(() => __vitePreload(() => import("./ResetPasswordPage-BiqQMUsx.js"), true ? __vite__mapDeps([20,6,7,15,16,8]) : void 0));
const EmailVerificationPage = React.lazy(() => __vitePreload(() => import("./EmailVerificationPage-DI63Gr3V.js"), true ? __vite__mapDeps([21,6,7,16,8]) : void 0));
const PricingPage = React.lazy(() => __vitePreload(() => import("./PricingPage-pe2W3jb4.js"), true ? __vite__mapDeps([22,6,7,10,11,12,8]) : void 0));
const TermsPage = React.lazy(() => __vitePreload(() => import("./TermsPage-MPD-jcJU.js"), true ? __vite__mapDeps([23,6,7,10,11,12,8]) : void 0));
const PrivacyPolicyPage = React.lazy(() => __vitePreload(() => import("./PrivacyPolicyPage-M6BdXBK3.js"), true ? __vite__mapDeps([24,6,7,10,11,12,8]) : void 0));
const SlaPage = React.lazy(() => __vitePreload(() => import("./SlaPage-8aCKLkFJ.js"), true ? __vite__mapDeps([25,6,7,10,11,12,8]) : void 0));
const CookiePolicyPage = React.lazy(() => __vitePreload(() => import("./CookiePolicyPage-Bt5QWQFA.js"), true ? __vite__mapDeps([26,6,7,10,11,12,8]) : void 0));
const CheckoutPage = React.lazy(() => __vitePreload(() => import("./CheckoutPage-Bufg-Is3.js"), true ? __vite__mapDeps([27,6,7,16,10,11,15,8]) : void 0));
const StandaloneCheckoutPage = React.lazy(() => __vitePreload(() => import("./StandaloneCheckoutPage-C_9uYmzC.js"), true ? __vite__mapDeps([28,6,7,8]) : void 0));
const DownloadPage = React.lazy(() => __vitePreload(() => import("./DownloadPage-C2qC9z1n.js"), true ? __vite__mapDeps([29,6,7,8]) : void 0));
const DashboardLayout = React.lazy(() => __vitePreload(() => import("./DashboardLayout-CM9-VymM.js"), true ? __vite__mapDeps([30,6,7,11,8]) : void 0));
const DashboardOverview = React.lazy(() => __vitePreload(() => import("./DashboardOverview-xbndMz35.js"), true ? __vite__mapDeps([31,6,7,0,1,2,3,32,33,4,5,8]) : void 0));
const DashboardCloudProjectsBridge = React.lazy(() => __vitePreload(() => import("./DashboardCloudProjectsBridge-BG2zaKl4.js").then((n) => n.D), true ? __vite__mapDeps([34,6,7,2,1,0,3,35,36,4,5,8]) : void 0));
const LicensesPage = React.lazy(() => __vitePreload(() => import("./LicensesPage-BUeG1qEo.js"), true ? __vite__mapDeps([37,6,7,33,4,2,1,5,0,3,8,16]) : void 0));
const SecurityDashboardPage = React.lazy(() => __vitePreload(() => import("./security-dashboard-DXfZzPUl.js"), true ? __vite__mapDeps([38,6,7,3,1,8]) : void 0));
const AnalyticsPage = React.lazy(() => __vitePreload(() => import("./AnalyticsPage-1wRjKUH4.js"), true ? __vite__mapDeps([39,6,7,33,4,2,1,5,0,3,8,32]) : void 0));
React.lazy(() => __vitePreload(() => import("./BillingPage-CIl8M4Vc.js"), true ? __vite__mapDeps([40,6,7,16,33,4,2,1,5,0,3,8,32]) : void 0));
const StreamlinedBillingPage = React.lazy(() => __vitePreload(() => import("./StreamlinedBillingPage-CKLF3Dw5.js"), true ? __vite__mapDeps([41,6,7,16,33,4,2,1,5,0,3,8,32]) : void 0));
const SettingsPage = React.lazy(() => __vitePreload(() => import("./SettingsPage-mktdhs3M.js"), true ? __vite__mapDeps([42,6,7,16,8]) : void 0));
const TeamPage = React.lazy(() => __vitePreload(() => import("./EnhancedTeamPage-Nd4gf2gh.js"), true ? __vite__mapDeps([43,6,7,16,33,4,2,1,5,0,3,8,32]) : void 0));
const TestStreamlinedHooks = React.lazy(() => __vitePreload(() => import("./TestStreamlinedHooks-TeIMdvJZ.js"), true ? __vite__mapDeps([44,6,7,33,4,2,1,5,0,3,8]) : void 0));
const DownloadsPage = React.lazy(() => __vitePreload(() => import("./DownloadsPage-Ou0W2x8Y.js"), true ? __vite__mapDeps([45,6,7,16,8]) : void 0));
const DocumentationPage = React.lazy(() => __vitePreload(() => import("./DocumentationPage-ClCqGW2k.js"), true ? __vite__mapDeps([46,6,7,16,10,11,12,8]) : void 0));
const SupportPage = React.lazy(() => __vitePreload(() => import("./SupportPage-DnxkJecC.js"), true ? __vite__mapDeps([47,6,7,16,10,11,12,8]) : void 0));
const InviteAcceptPage = React.lazy(() => __vitePreload(() => import("./InviteAcceptPage-Cc9nhYsh.js"), true ? __vite__mapDeps([48,6,7,16,8]) : void 0));
const AdminDashboard = React.lazy(() => __vitePreload(() => import("./AdminDashboard-IVS7j0qx.js"), true ? __vite__mapDeps([49,6,7,16,2,1,0,3,5,8]) : void 0));
const AccountingDashboard = React.lazy(() => __vitePreload(() => import("./AccountingDashboard-CLJ7EhA_.js"), true ? __vite__mapDeps([50,6,7,8]) : void 0));
const NotFoundPage = React.lazy(() => __vitePreload(() => import("./NotFoundPage-C-LO-7TA.js"), true ? __vite__mapDeps([51,6,7]) : void 0));
const StartupWorkflow = React.lazy(() => __vitePreload(() => import("./StartupWorkflow-DXd_4N-o.js"), true ? __vite__mapDeps([52,6,7,36,35,14,15,16,8]) : void 0));
const OfflineTestPage = React.lazy(() => __vitePreload(() => import("./OfflineTestPage-CFPUO6j5.js"), true ? __vite__mapDeps([53,6,7,35,8]) : void 0));
const TestInviteDialog = React.lazy(() => __vitePreload(() => import("./TestInviteDialog-w5n5AfOQ.js"), true ? __vite__mapDeps([54,6,7,16,8]) : void 0));
const TestTeamMemberCreation = React.lazy(() => __vitePreload(() => import("./TestTeamMemberCreation-Bbhi4nBh.js"), true ? __vite__mapDeps([55,6,7,16,33,4,2,1,5,0,3,8]) : void 0));
const TestTeamMemberCreationSimple = React.lazy(() => __vitePreload(() => import("./TestTeamMemberCreationSimple-oRNTUloW.js"), true ? __vite__mapDeps([56,6,7,16,8]) : void 0));
