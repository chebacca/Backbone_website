...
import { g as getApp, _ as _getProvider, b as getDefaultEmulatorHostnameAndPort, a as getModularInstance, i as isCloudWorkstation, p as pingServer, u as updateEmulatorBanner, q as deepEqual, e as createMockUserToken, F as FirebaseError, L as Logger, B as LogLevel, K as isSafari, s as getUA, S as SDK_VERSION, c as _registerComponent, C as Component, r as registerVersion, d as _isFirebaseServerApp } from "./index.esm-zVCMB3Cx.js";
...
class __PRIVATE_View {
  ...
  applyChanges(e, t, n, r) {
    ...
    }(e2.type, t2.type) || this.eu(e2.doc, t2.doc)), this.ou(n), r = r != null ? r : false;
...
class __PRIVATE_MemoryOfflineComponentProvider {
  ...
  terminate() {
    return __async(this, null, function* () {
      var _a, _b;
      (_a = this.gcScheduler) == null ? void 0 : _a.stop(), (_b = this.indexBackfillerScheduler) == null ? void 0 : _b.stop(), this.sharedClientState.shutdown(), yield this.persistence.shutdown();
    });
  }
}
...
class FirestoreSettingsImpl {
  constructor(e) {
    ...
    } else this.host = e.host, this.ssl = (_a = e.ssl) != null ? _a : un;
...
class __PRIVATE_ParseContextImpl {
  ...
  Vc(e) {
    return new __PRIVATE_ParseContextImpl(__spreadValues(__spreadValues({}, this.settings), e), this.databaseId, this.serializer, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
  }
  mc(e) {
    var _a;
...
function onSnapshot(e, ...t) {
  ...
  return function __PRIVATE_firestoreClientListen(e2, t2, n2, r2) {
    ...
    return e2.asyncQueue.enqueueAndForget(() => __async(this, null, function* () {
      ...
      i2.Nu(), e2.asyncQueue.enqueueAndForget(() => __async(this, null, function* () {
