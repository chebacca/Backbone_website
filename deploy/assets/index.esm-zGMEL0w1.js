import{h as Wt,c as tt,j as nt,k as Ht,l as T,m as me,n as Ee,p as qt,u as Kt,d as g,o as f,E as ye,q as $t,s as Gt,S as j,t as B,v as jt,w as Bt,F as ve,x as H,y as q,L as zt,z as rt,A as Jt,B as Yt,C as Xt,e as Le,G as Ue,r as Me,H as Qt}from"./index.esm-DFeBm_6f.js";function it(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Zt=it,st=new ye("auth","Firebase",it());/**
 * @license
 ...
 */const ie=new zt("@firebase/auth");function en(n,...e){ie.logLevel<=rt.WARN&&ie.warn(`Auth (${j}): ${n}`,...e)}function ee(n,...e){ie.logLevel<=rt.ERROR&&ie.error(`Auth (${j}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
