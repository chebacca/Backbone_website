...
export {
  ...
  ErrorFactory as E,
  FirebaseError as F,
  isBrowserExtension as G,
  base64Decode as H,
  isCloudflareWorker as I,
  createSubscribe as J,
  isSafari as K,
  Logger as L,
  SDK_VERSION as S,
  _getProvider as _,
  getModularInstance as a,
  getDefaultEmulatorHostnameAndPort as b,
  _registerComponent as c,
  _isFirebaseServerApp as d,
  createMockUserToken as e,
  initializeApp as f,
  getApp as g,
  getApps as h,
  ...
  _components as l,
  _serverApps as m,
  getExperimentalSetting as n,
  getDefaultEmulatorHost as o,
  pingServer as p,
  deepEqual as q,
  registerVersion as r,
  getUA as s,
  querystringDecode as t,
  updateEmulatorBanner as u,
  extractQuerystring as v,
  isIE as w,
  isEmpty as x,
  querystring as y,
  isMobileCordova as z
};
