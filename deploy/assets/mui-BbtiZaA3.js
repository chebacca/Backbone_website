...
function createBox(options = {}) {
  ...
  const Box2 = /* @__PURE__ */ reactExports.forwardRef(function Box3(inProps, ref) {
    ...
    const _extendSxProp = extendSxProp(inProps), {
      className,
      component = "div"
    } = _extendSxProp, other = _objectWithoutPropertiesLoose(_extendSxProp, _excluded$1R);
...
const _excluded$1Q = ["ownerState"], _excluded2$b = ["variants"], _excluded3$4 = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
...
function useSlotProps(parameters) {
  ...
  } = parameters, rest = _objectWithoutPropertiesLoose(parameters, _excluded$1P);
...
const _excluded$1N = ["className", "component", "disableGutters", "fixed", "maxWidth", "classes"];
...
const useUtilityClasses$1u = (ownerState, componentName) => {
...
function createContainer(options = {}) {
  ...
  const Container2 = /* @__PURE__ */ reactExports.forwardRef(function Container22(inProps, ref) {
    ...
    const classes = useUtilityClasses$1u(ownerState, componentName);
    return (
...
const _excluded$1M = ["component", "direction", "spacing", "divider", "children", "className", "useFlexGap"];
...
const _excluded$1L = ["mode", "contrastThreshold", "tonalOffset"];
const light = {
...
function createPalette(palette) {
  const {
    ...
    contrastThreshold = 3,
    tonalOffset = 0.2
  } = palette, other = _objectWithoutPropertiesLoose(palette, _excluded$1L);
...
const _excluded$1K = ["fontFamily", "fontSize", "fontWeightLight", "fontWeightRegular", "fontWeightMedium", "fontWeightBold", "htmlFontSize", "allVariants", "pxToRem"];
...
function createTypography(palette, typography) {
  const _ref = typeof typography === "function" ? typography(palette) : typography, {
    ...
    allVariants,
    pxToRem: pxToRem2
  } = _ref, other = _objectWithoutPropertiesLoose(_ref, _excluded$1K);
...
const _excluded$1J = ["duration", "easing", "delay"];
const easing = {
...
function createTransitions(inputTransitions) {
  ...
  const create = (props = ["all"], options = {}) => {
    ...
    _objectWithoutPropertiesLoose(options, _excluded$1J);
...
const _excluded$1I = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
...
const _excluded$1H = ["ownerState"], _excluded2$a = ["variants"], _excluded3$3 = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
...
function processStyleArg(callableStyle, _ref, layerName) {
  let {
    ownerState
  } = _ref, props = (0, _objectWithoutPropertiesLoose2.default)(_ref, _excluded$1H);
...
const _excluded$1F = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"];
...
const _excluded$1C = ["className", "elementType", "ownerState", "externalForwardedProps", "getSlotOwnerState", "internalForwardedProps"], _excluded2$9 = ["component", "slots", "slotProps"], _excluded3$2 = ["component"];
function useSlot(name, parameters) {
  ...
  } = parameters, useSlotPropsParams = _objectWithoutPropertiesLoose(parameters, _excluded$1C);
  const {
...
const _excluded$1B = ["children", "className", "defaultExpanded", "disabled", "disableGutters", "expanded", "onChange", "square", "slots", "slotProps", "TransitionComponent", "TransitionProps"];
...
const _excluded$1q = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"];
...
const _excluded$1m = ["aria-describedby", "autoComplete", "autoFocus", "className", "color", "components", "componentsProps", "defaultValue", "disabled", "disableInjectingGlobalStyles", "endAdornment", "error", "fullWidth", "id", "inputComponent", "inputProps", "inputRef", "margin", "maxRows", "minRows", "multiline", "name", "onBlur", "onChange", "onClick", "onFocus", "onKeyDown", "onKeyUp", "placeholder", "readOnly", "renderSuffix", "rows", "size", "slotProps", "slots", "startAdornment", "type", "value"];
...
const _excluded$1l = ["autoComplete", "autoHighlight", "autoSelect", "blurOnSelect", "ChipProps", "className", "clearIcon", "clearOnBlur", "clearOnEscape", "clearText", "closeText", "componentsProps", "defaultValue", "disableClearable", "disableCloseOnSelect", "disabled", "disabledItemsFocusable", "disableListWrap", "disablePortal", "filterOptions", "filterSelectedOptions", "forcePopupIcon", "freeSolo", "fullWidth", "getLimitTagsText", "getOptionDisabled", "getOptionKey", "getOptionLabel", "isOptionEqualToValue", "groupBy", "handleHomeEndKeys", "id", "includeInputInList", "inputValue", "limitTags", "ListboxComponent", "ListboxProps", "loading", "loadingText", "multiple", "noOptionsText", "onChange", "onClose", "onHighlightChange", "onInputChange", "onOpen", "open", "openOnFocus", "openText", "options", "PaperComponent", "PopperComponent", "popupIcon", "readOnly", "renderGroup", "renderInput", "renderOption", "renderTags", "selectOnFocus", "size", "slotProps", "value"], _excluded2$7 = ["ref"], _excluded3$1 = ["key"], _excluded4 = ["key"];
...
const _excluded$1k = ["alt", "children", "className", "component", "slots", "slotProps", "imgProps", "sizes", "src", "srcSet", "variant"];
...
const _excluded$1d = ["disableSpacing", "className"];
...
const _excluded$1b = ["action", "avatar", "className", "component", "disableTypography", "subheader", "subheaderTypographyProps", "title", "titleTypographyProps"];
...
const _excluded$19 = ["checkedIcon", "color", "icon", "indeterminate", "indeterminateIcon", "inputProps", "size", "className"];
...
const _excluded$18 = ["className", "color", "disableShrink", "size", "style", "thickness", "value", "variant"];
...
const _excluded$17 = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"];
...
const _excluded$16 = ["aria-describedby", "aria-labelledby", "BackdropComponent", "BackdropProps", "children", "className", "disableEscapeKeyDown", "fullScreen", "fullWidth", "maxWidth", "onBackdropClick", "onClick", "onClose", "open", "PaperComponent", "PaperProps", "scroll", "TransitionComponent", "transitionDuration", "TransitionProps"];
...
const _excluded$15 = ["className", "disableSpacing"];
...
const _excluded$14 = ["className", "dividers"];
...
const _excluded$13 = ["className", "id"];
...
const _excluded$12 = ["absolute", "children", "className", "component", "flexItem", "light", "orientation", "role", "textAlign", "variant"];
...
const _excluded$11 = ["addEndListener", "appear", "children", "container", "direction", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"];
...
const _excluded$10 = ["BackdropProps"], _excluded2$6 = ["anchor", "BackdropProps", "children", "className", "elevation", "hideBackdrop", "ModalProps", "onClose", "open", "PaperProps", "SlideProps", "TransitionComponent", "transitionDuration", "variant"];
...
const Drawer = /* @__PURE__ */ reactExports.forwardRef(function Drawer2(inProps, ref) {
  ...
  const {
    ...
    transitionDuration = defaultTransitionDuration,
    variant = "temporary"
  } = props, ModalProps = _objectWithoutPropertiesLoose(props.ModalProps, _excluded$10), other = _objectWithoutPropertiesLoose(props, _excluded2$6);
...
const _excluded$_ = ["disableUnderline", "components", "componentsProps", "fullWidth", "hiddenLabel", "inputComponent", "multiline", "slotProps", "slots", "type"];
...
const _excluded$U = ["className", "columns", "columnSpacing", "component", "container", "direction", "item", "rowSpacing", "spacing", "wrap", "zeroMinWidth"];
...
const _excluded$S = ["disableUnderline", "components", "componentsProps", "fullWidth", "inputComponent", "multiline", "slotProps", "slots", "type"];
...
const _excluded$P = ["className", "color", "value", "valueBuffer", "variant"];
...
const _excluded$O = ["className", "color", "component", "onBlur", "onFocus", "TypographyClasses", "underline", "variant", "sx"];
...
const _excluded$K = ["className"], _excluded2$5 = ["alignItems", "autoFocus", "button", "children", "className", "component", "components", "componentsProps", "ContainerComponent", "ContainerProps", "dense", "disabled", "disableGutters", "disablePadding", "divider", "focusVisibleClassName", "secondaryAction", "selected", "slotProps", "slots"];
...
const ListItem = /* @__PURE__ */ reactExports.forwardRef(function ListItem2(inProps, ref) {
  ...
  const {
    ...
    slotProps = {},
    slots = {}
  } = props, ContainerProps = _objectWithoutPropertiesLoose(props.ContainerProps, _excluded$K), other = _objectWithoutPropertiesLoose(props, _excluded2$5);
  const context = reactExports.useContext(ListContext);
  const childContext = reactExports.useMemo(() => ({
    dense: dense || context.dense || false,
    alignItems,
...
const _excluded$F = ["onEntering"], _excluded2$4 = ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "slots", "slotProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps", "disableScrollLock"], _excluded3 = ["slotProps"];
...
const Popover = /* @__PURE__ */ reactExports.forwardRef(function Popover2(inProps, ref) {
  ...
  const {
    ...
    disableScrollLock = false
  } = props, TransitionProps = _objectWithoutPropertiesLoose(props.TransitionProps, _excluded$F), other = _objectWithoutPropertiesLoose(props, _excluded2$4);
...
const _excluded$E = ["onEntering"], _excluded2$3 = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"];
const RTL_ORIGIN = {
  vertical: "top",
  horizontal: "right"
};
...
const Menu = /* @__PURE__ */ reactExports.forwardRef(function Menu2(inProps, ref) {
  ...
  const {
    ...
    slots = {},
    slotProps = {}
  } = props, TransitionProps = _objectWithoutPropertiesLoose(props.TransitionProps, _excluded$E), other = _objectWithoutPropertiesLoose(props, _excluded2$3);
  const isRtl = useRtl();
  const ownerState = _extends$1({}, props, {
    autoFocus,
...
const _excluded$D = ["autoFocus", "component", "dense", "divider", "disableGutters", "focusVisibleClassName", "role", "tabIndex", "className"];
...
const _excluded$y = ["className", "color", "component", "components", "disabled", "page", "selected", "shape", "size", "slots", "type", "variant"];
...
const _excluded$w = ["checked", "checkedIcon", "color", "icon", "name", "onChange", "size", "className"];
const useUtilityClasses$u = (ownerState) => {
  const {
    classes,
    color: color2,
...
const _excluded$v = ["actions", "children", "className", "defaultValue", "name", "onChange", "value"];
...
const _excluded$t = ["autoWidth", "children", "classes", "className", "defaultOpen", "displayEmpty", "IconComponent", "id", "input", "inputProps", "label", "labelId", "MenuProps", "multiple", "native", "onClose", "onOpen", "open", "renderValue", "SelectDisplayProps", "variant"], _excluded2$2 = ["root"];
const useUtilityClasses$r = (ownerState) => {
  const {
    classes
  } = ownerState;
...
const _excluded$r = ["aria-label", "aria-valuetext", "aria-labelledby", "component", "components", "componentsProps", "color", "classes", "className", "disableSwap", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "orientation", "shiftStep", "size", "step", "scale", "slotProps", "slots", "tabIndex", "track", "value", "valueLabelDisplay", "valueLabelFormat"];
...
const _excluded$p = ["onEnter", "onExited"], _excluded2$1 = ["action", "anchorOrigin", "autoHideDuration", "children", "className", "ClickAwayListenerProps", "ContentProps", "disableWindowBlurListener", "message", "onBlur", "onClose", "onFocus", "onMouseEnter", "onMouseLeave", "open", "resumeHideDuration", "TransitionComponent", "transitionDuration", "TransitionProps"];
const useUtilityClasses$n = (ownerState) => {
  const {
    classes,
    anchorOrigin
...
const Snackbar = /* @__PURE__ */ reactExports.forwardRef(function Snackbar2(inProps, ref) {
  ...
  } = props, TransitionProps = _objectWithoutPropertiesLoose(props.TransitionProps, _excluded$p), other = _objectWithoutPropertiesLoose(props, _excluded2$1);
  const ownerState = _extends$1({}, props, {
    anchorOrigin: {
      vertical,
      horizontal
...
export {
  ...
  Accordion as O,
  PropTypes as P,
  AccordionSummary as Q,
  RefreshIcon as R,
  Stack as S,
  Typography as T,
  ExpandMoreIcon as U,
  VisibilityOff as V,
  AccordionDetails as W,
  Group as X,
  Business as Y,
  AlertTitle as Z,
  WarningIcon as _,
  ...
  LocationOn as af,
  CreditCard as ag,
  MonetizationOn as ah,
  Receipt as ai,
  TrendingUp as aj,
  TableContainer as ak,
  Table as al,
  TableHead as am,
  TableRow as an,
  TableCell as ao,
  ...
  DialogActions as aw,
  PhotoCamera as ax,
  ListItemSecondaryAction as ay,
  DeleteIcon as az,
  Container as b,
  Slider as b$,
  Message as b0,
  IntegrationInstructions as b1,
  Psychology as b2,
  SearchIcon as b3,
  Inventory as b4,
  DesktopMac as b5,
  ...
  Logout as bJ,
  Drawer as bK,
  AccountBalance as bL,
  ListItemButton as bM,
  BlockIcon as bN,
  CardHeader as bO,
  ReceiptLong as bP,
  AddIcon as bQ,
  ...
  MusicIcon as cB,
  CampaignIcon as cC,
  ListItemAvatar as cD,
  HelpIcon as cE,
  ArchiveIcon as cF,
  TableSortLabel as cG,
  StopIcon as cH,
  TablePagination as cI,
  CheckCircleOutlineIcon as cJ,
  Backdrop as cK,
  ErrorOutline as cL,
  createTheme as cM,
  ThemeProvider as cN,
  ...
  CardActions as cd,
  SortIcon as ce,
  FolderOpenIcon as cf,
  Fade as cg,
  utils as ch,
  interopRequireDefaultExports as ci,
  AdminPanelSettings as cj,
  ExitToApp as ck,
  RocketLaunch as cl,
  Snackbar as cm,
  ExtensionIcon as cn,
  ...
  GroupAddIcon as cq,
  CancelIcon as cr,
  CollectionsIcon as cs,
  CategoryIcon as ct,
  ExpandLessIcon as cu,
  SelectAllIcon as cv,
  DeselectAllIcon as cw,
  LightbulbIcon as cx,
  EventIcon as cy,
  SportsIcon as cz,
  Alert as d,
