...
/**
 * Working Collections Restore Script (Application Default Credentials)
 * 
 * This script uses Firebase Admin SDK with Application Default Credentials
 * to create placeholder documents in all collections that have indexes,
 * making them visible in console.
 */
...
function initializeFirebase() {
  try {
    ...
    console.log('   2. Set project: gcloud config set project backbone-logic');
...
async function createPlaceholderDocument(db, collectionName) {
  try {
    ...
    const placeholderData = {
      ...
      restoredAt: new Date(),
      restoredBy: 'restore-collections-adc-script'
    };
